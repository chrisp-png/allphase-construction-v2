...
const manualPublicCopyPlugin = () => ({
  ...
  closeBundle() {
    ...
    // Copy SEO files (robots.txt, sitemap.xml, sitemap.html, _headers, and _prerender.json)
    const seoFiles = ['robots.txt', 'sitemap.xml', 'sitemap.html', '_headers', '_prerender.json'];
