  ...
  '/roof-replacement': {
    ...
    '/roof-cost-calculator': {
      faqs: [
        ...
        { question: 'Does insurance cover roof replacement in Florida?', answer: 'Insurance covers roof replacement in Florida only when damage results from a covered peril (wind, hail, fire) rather than normal wear and age-related deterioration. Wind damage from hurricanes or tropical storms is commonly covered, subject to deductibles and policy limits. Age-related granule loss, UV degradation, and general wear are not covered. Many Florida policies now include special hurricane deductibles (percentage of dwelling coverage) and depreciation schedules that reduce coverage as roofs age. Always obtain a professional roof inspection to document storm damage before filing claims.' },
        ...
        { question: 'Should I add wind mitigation upgrades during my reroof?', answer: 'Absolutely. Most wind mitigation upgrades can only be done during a reroof. The insurance savings alone ($2,000-$3,000+ per year) typically pay for the upgrades within 1-2 years. Over 20 years, that\'s $40,000-$60,000 in savings.' },
        { question: 'Do solar attic fans really make a difference on roof lifespan?', answer: 'Yes. Solar attic fans vent heat and humidity, reducing thermal shock on your underlayment and extending roof life. They also lower A/C costs by reducing attic temperatures where ductwork runs.' },
        { question: 'How do I know if a roofer is cutting corners on tile installation?', answer: 'Ask about the foam adhesive: what brand, what grade, what size foam pad under each tile, and whether the permit matches. This is the #1 area where roofers cut corners on tile roofs.' },
        { question: 'Is it worth financing extra roof upgrades?', answer: 'In most cases, yes. Financing an additional $5,000 for wind mitigation and ventilation typically pays for itself within 2 years through insurance and energy savings, with pure savings for the remaining 18 years of your roof\'s life.' },
      ],
      breadcrumbs: [
        { name: 'Home', url: 'https://allphaseconstructionfl.com/' },
