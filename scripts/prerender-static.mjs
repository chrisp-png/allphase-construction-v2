    ...
    <div style="max-width: 900px; margin: 0 auto;">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: center; padding: 1.5rem 0; border-top: 1px solid rgba(255,255,255,0.15); border-bottom: 1px solid rgba(255,255,255,0.15);">
        ...
        <div style="display: flex; align-items: center; gap: 0.5rem;">
          ...
          <span style="color: #e5e7eb; font-weight: 600;">4.9 Google Rating</span>
  ...
  <div style="background: #111827; color: white; padding: 4rem 2rem; margin: 3rem -1rem;">
    <div style="max-width: 900px; margin: 0 auto;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-bottom: 2.5rem;">
        ...
        <div style="background: rgba(255,255,255,0.05); padding: 1.5rem; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);">
          <div style="color: #fbbf24; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;">4.9⭐</div>
...
const CITY_UNIQUE_CONTENT = {
  ...
  'coral-springs': {
    ...
    localContext: `Coral Springs is a master-planned city in western Broward County known for its well-maintained neighborhoods and strong community standards. The Heron Bay community alone contains 30+ sub-neighborhoods with golf course estates and resort-style amenities. Properties near Mullins Park &mdash; the city's largest at 70 acres &mdash; and The Sportsplex anchor the central residential core where many homes built during the 1980s-90s growth boom now need roof replacement. The Tall Cypress Natural Area provides a green buffer for western neighborhoods.`,
  ...
  'pembroke-pines': {
    ...
    localContext: `Pembroke Pines is one of Broward County's most populous cities with diverse residential development from the 1960s through today. C.B. Smith Park &mdash; featuring batting cages, tennis courts, and Paradise Cove Water Park &mdash; anchors the eastern residential core. Chapel Trail Nature Preserve encompasses 450 acres with a 1,650-foot boardwalk through wetlands, and its surrounding residential community represents one of the city's largest concentrations of homes needing roof replacement. The Shops at Pembroke Gardens and Pembroke Lakes Regional Mall generate commercial roofing demand.`,
...
function generateRoofingServicesContent() {
  return `
    <section id="seo-static-content">
      ...
      <p>All Phase Construction USA is a dual-licensed roofing and general contractor serving Broward and Palm Beach Counties since 2006. With over 2,500 completed projects and certifications from Owens Corning, CertainTeed, and Tamko, we specialize in HVHZ-compliant roofing built to South Florida&rsquo;s 146 mph wind load requirements.</p>
...
<section id="seo-static-content">
  ...
  <h2>Why the Ranges Are Wide: Code-Minimum vs. Insurance-Optimized</h2>
  <p>Every price range on this page runs from a <strong>code-minimum build</strong> at the low end to an <strong>insurance-optimized build</strong> at the high end. A code-minimum roof passes inspection and nothing more: standard underlayment, baseline fastening, and few or no wind-mitigation credits. An insurance-optimized roof is built to High-Velocity Hurricane Zone specification even where it is not legally required — full secondary water barrier, enhanced roof-to-wall connections, sealed roof deck, and documented wind-mitigation features that Florida insurers grant premium discounts for.</p>

  <h2>Why the Lowest Bid Usually Costs the Most Over Time</h2>
  <p><strong>The cheapest roof bid is usually the most expensive roof to own.</strong> The install price is only half the cost of a roof in South Florida — the other half is what the homeowner pays in insurance premiums every year afterward. As an illustrative example using the same assumptions as our calculator: a typical tile-roofed single-family home in Broward or Palm Beach County might pay roughly $6,800&ndash;$9,200 per year in premiums with a code-minimum roof, versus roughly $3,800&ndash;$5,400 per year with an insurance-optimized roof. That is thousands of dollars per year, every year, across a 20&ndash;25 year roof life &mdash; which is why the higher up-front cost of an optimized installation typically pays for itself within about three to six years, with everything after that being ongoing savings.</p>
  <p>Florida premiums also tend to ratchet upward after major hurricane seasons and rarely come back down, so a roof that earns maximum wind-mitigation discounts keeps the homeowner on the lower side of every future increase. Practical advice we give every homeowner: <strong>do not compare roofing bids on price alone</strong>. Compare them on which wind-mitigation features are included and which insurance discounts the finished roof will document and earn &mdash; then have a wind mitigation inspection (OIR-B1-1802 form) done after installation so the discounts are actually applied.</p>
...
<section id="seo-static-content">
  ...
  <p><strong>Flat and low-slope roofs need a different system than pitched roofs.</strong> All Phase Construction USA installs and replaces single-ply and built-up flat roofs across Broward and Palm Beach County — on modern homes, additions, and commercial buildings — engineered for standing water, intense UV, and high winds.</p>
    <p><strong>Condo or HOA building?</strong> Your association can finance a full roof replacement with monthly payments instead of a lump-sum special assessment — see our <a href="/hoa-condo-roof-financing" style="color:#dc2626;text-decoration:underline;">Condo &amp; HOA Roof Financing</a> program.</p>
  ...
  const SERVICE_PAGE_SCHEMAS = {
    '/hoa-condo-roof-financing': {
      ...
      breadcrumbs: [
        ...
        { name: 'Condo & HOA Roof Financing', url: 'https://allphaseconstructionfl.com/hoa-condo-roof-financing' }
      ]
    },
    '/free-roof-estimate': {
      faqs: [
...
`;
  ...
  <p>Fort Lauderdale is home to the world-famous Las Olas Boulevard, a vibrant commercial and cultural hub, and the New River, which winds through historic neighborhoods featuring Mediterranean revival and tropical contemporary architecture. The city's waterfront properties &mdash; from the 6-mile beach to the scenic Intracoastal &mdash; face relentless salt spray and storm surge exposure. Victoria Park's tree-lined streets house vintage homes with aging roof systems, while Coral Ridge represents one of South Florida's most prestigious residential enclaves with complex architectural roofing requirements. Las Olas Beach Park and Harbor Branch provide landmarks for understanding storm exposure patterns. Fort Lauderdale's entire jurisdiction falls within Broward County's High Velocity Hurricane Zone, with design wind speeds exceeding 175 mph. Every roofing contractor operating in Fort Lauderdale must carry HVHZ certification and understand the advanced fastening and flashing systems required.</p>
  <h2>Your List of the Top 5 Best Roofers in Fort Lauderdale, FL</h2>
  <ol>
    <li><strong>All Phase Construction USA</strong> &mdash; Dual-licensed (CCC-1331464 &amp; CGC-1526236), HVHZ-certified, 2,500+ completed roofs, 4.9/5 rating from 138+ reviews. Headquartered at 590 Goolsby Blvd in nearby Deerfield Beach for rapid response. Tamko Pro Platinum certified, in business since 2006.</li>
...
`;
  ...
  <ol>
    <li><strong>All Phase Construction USA</strong> &mdash; Dual-licensed (CCC-1331464 &amp; CGC-1526236), wind-borne debris region certified, 2,500+ completed roofs, 4.9/5 rating from 138+ reviews. Serves Palm Beach County with expertise in historic preservation and modern impact-resistant systems. In business since 2006, Tamko Pro Platinum certified.</li>
...
`;
  ...
  <ol>
    <li><strong>All Phase Construction USA</strong> &mdash; Dual-licensed (CCC-1331464 &amp; CGC-1526236), wind-borne debris region certified, 2,500+ completed roofs, 4.9/5 rating from 138+ reviews. Serves Palm Beach County with expertise in upscale residential and HOA-governed communities. In business since 2006, Tamko Pro Platinum certified.</li>
...
`;
  ...
  <ol>
    <li><strong>All Phase Construction USA</strong> &mdash; Dual-licensed (CCC-1331464 &amp; CGC-1526236), HVHZ-certified, 2,500+ completed roofs, 4.9/5 rating from 138+ reviews. Extensive experience coordinating with Coral Springs HOA boards across Eagle Trace, Heron Bay, and Ramblewood. In business since 2006, Tamko Pro Platinum certified.</li>
...
`;
  ...
  <ol>
    <li><strong>All Phase Construction USA</strong> &mdash; Dual-licensed (CCC-1331464 &amp; CGC-1526236), wind-borne debris region certified, 2,500+ completed roofs, 4.9/5 rating from 138+ reviews. Extensive experience coordinating with Wellington HOA boards and understanding equestrian estate requirements. In business since 2006, Tamko Pro Platinum certified.</li>
...
<p>The result is a roof built on a sound, inspected deck with a brand-new waterproofing layer — the only way to get a full manufacturer warranty and decades of service.</p>`,
      title: "Why You Can't Overlay a Roof in Delray Beach",
      description: 'A contractor pitched you a roof-over in Delray Beach? Florida HVHZ code makes that almost impossible — here is exactly why a full tear-off is the right call.',
