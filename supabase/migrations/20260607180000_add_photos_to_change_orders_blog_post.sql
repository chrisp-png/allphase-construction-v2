/*
  # Update Blog Post: add project photos to change-orders post

  - Slug: understanding-roof-change-orders-hidden-wood-damage
  - Sets featured_image to /projects/delray-beach-tile-tear-off-and-deck-inspection-all-phase-usa.webp
  - Replaces content with HTML that includes 4 inline <figure> images
    (rotted decking, pest damage, full re-deck, and board-numbering/transparency),
    all served from /projects/ in the repo. published stays true.
...
<p><strong>✉️ Email:</strong> <a href="mailto:info@allphaseusa.com">info@allphaseusa.com</a></p>
