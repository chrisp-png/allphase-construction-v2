...
export const SEO_TITLES: Record<string, SEOMetadata> = {
  ...
  '/roof-cost-calculator': {
    title: '2026 Roof Cost Calculator | Broward & Palm Beach County',
    description: 'Instant 2026 roof cost estimates for South Florida. Shingle $8-$12/sq ft. Tile $10-$18/sq ft. Metal $12-$20/sq ft. HVHZ-certified. Free, no obligation.',
