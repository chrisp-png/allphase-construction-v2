    ...
    return (
      <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm border border-green-600/30 rounded-2xl p-8 shadow-2xl">
        <div className="flex items-start gap-6">
          ...
          <div>
            <p className="text-green-400 font-semibold text-xl mb-2">Your guide is downloading now!</p>
    ...
    <div id="checklist-download" className="bg-gradient-to-br from-slate-800/60 to-blue-900/20 backdrop-blur-sm border border-blue-600/20 rounded-2xl p-8 shadow-2xl">
      <div className="flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="flex-1">
          ...
          {error && (
            <div className="mb-3 p-3 bg-red-900/20 border border-red-600/50 rounded-lg text-red-400 text-base">
              {error}
            </div>
          )}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 min-w-0 px-4 py-3 bg-slate-900 border border-slate-600 rounded-lg text-white text-base placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
              />
              <input
                type="email"
                name="email"
