    ...
    <section className="py-16 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <a
            href="/projects/"
            className="inline-block px-8 py-3 border-2 border-red-400 text-red-400 font-semibold rounded-lg hover:bg-red-400 hover:text-black transition-colors duration-300"
          >
            View All Projects
          </a>
        </div>
