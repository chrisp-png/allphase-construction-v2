...
const caseStudies = [
  {
    ...
    imageAlt: 'Barrel tile roof replacement in Boca Raton by All Phase Construction USA',
  ...
  },
  {
    ...
    imageAlt: 'Shingle roof replacement in Fort Lauderdale by All Phase Construction USA',
