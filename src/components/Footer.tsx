        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <div className="border-t border-neutral-800 pt-10">
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 text-sm text-gray-400">
              <a href="https://www.bbb.org/us/fl/deerfield-bch/profile/roofing-contractors/all-phase-construction-usa-llc-0633-90537640" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="View our A+ accredited BBB Business Profile">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-white">FRSA Member</span>
              </div>
              <a href="https://rcasf.org/contractors/find-a-contractor/contractor.html?cid=1033" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="Member of the Roofing Contractors Association of South Florida">
                <svg className="w-5 h-5 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="font-medium text-white">RCASF Member</span>
              </a>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div>
            ...
            {/* PR-69: 24/7 availability block — matches GBP + GLSA wording
        ...
        <div className="border-t border-neutral-800 pt-8 mb-8">
          <div className="flex justify-center gap-6">
            ...
            <a
              href="https://x.com/AllPhaseUSALLC"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-red-600 transition-colors"
