      ...
      {services.map((service) => {
        ...
        return (
          <a
            key={service.title}
            href={service.href}
            className="group relative bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:shadow-red-900/20 hover:-translate-y-2 hover:border-red-600/50 transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
          >
            ...
            <div className="relative flex flex-col items-start gap-3">
              {/* Icon */}
              <div className="flex items-center justify-center w-10 h-10 bg-gray-700/50 rounded-lg group-hover:bg-red-600/20 transition-colors duration-300">
                <IconComponent className="w-5 h-5 text-gray-300 group-hover:text-red-500 group-hover:scale-110 transition-all duration-300" />
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-xs text-gray-400 group-hover:text-red-400 transition-colors mt-0.5">
                  {service.subtitle}
                </span>
              </div>
            </div>
