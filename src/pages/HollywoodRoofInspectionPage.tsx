...
export default function HollywoodRoofInspectionPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Hollywood FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Hollywood FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.';
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Why Choose Our Hollywood Roof Inspection Service?</h2>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">How Our Hollywood Roof Inspection Process Works</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                step: '01',
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Common Roof Problems in Hollywood Homes</h2>
          <p className="text-zinc-400 mb-8">Hollywood homes face unique roofing challenges due to the subtropical climate &mdash; high winds, heavy rainfall, and intense sunlight. Here are the most common issues we find:</p>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">What Makes Our Hollywood Roof Inspections Different?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
