...
export default function DelrayBeachCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Delray Beach Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Delray Beach roofing projects. Final pricing depends on inspection, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Delray Beach roofing projects. Final pricing depends on inspection, roof complexity, and material selection.';
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It is a starting point only. Final pricing follows inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What changes roof pricing in Delray Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Roof size, roof type, tear-off requirements, and deck condition."
          }
        },
        {
          "@type": "Question",
          "name": "Can I see monthly payments here?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Use the financing calculator above."
          }
        }
      ]
    };
  ...
  const faqs = [
    {
      ...
      answer: "It is a starting point only. Final pricing follows inspection."
    },
    {
      question: 'What changes roof pricing in Delray Beach?',
      answer: "Roof size, roof type, tear-off requirements, and deck condition."
    },
    {
      question: 'Can I see monthly payments here?',
      answer: "Yes. Use the financing calculator above."
    }
  ];
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/delray-beach/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Delray Beach
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-6 leading-relaxed">
              Use this roof cost calculator to get a fast ballpark estimate based on roof size and roof type. Final pricing depends on inspection and material selection.
            </p>
          </div>
          ...
          <div className="mb-20 mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Delray Beach roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Delray Beach?
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Delray Beach Roof Cost Calculator
            </h2>
