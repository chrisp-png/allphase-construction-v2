...
export default function PlantationRoofInspectionPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Plantation FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Plantation FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.';
  ...
  const faqs = [
    {
      question: 'How often should I inspect my roof in Plantation?',
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Why Choose Our Plantation Roof Inspection Service?</h2>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Common Roof Problems in Plantation Homes</h2>
          <p className="text-zinc-400 mb-8">Plantation homes face unique roofing challenges due to the subtropical climate &mdash; high winds, heavy rainfall, and intense sunlight. Here are the most common issues we find:</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: 'The combination of humidity and frequent rain creates ideal conditions for mold and algae to thrive on Plantation roofs. These growths weaken roofing materials and lead to further damage if left untreated.',
              },
              {
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">What Makes Our Plantation Roof Inspections Different?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
              ...
              },
              {
                ...
                body: 'Extensive experience identifying wind, hail, and water leak damage specific to South Florida storms, including subtle red flags that untrained eyes miss. We know what Plantation’s weather does to roofs.',
              },
              {
