        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-zinc-950 p-8 rounded-lg border border-zinc-800">
            <p className="text-zinc-300 leading-relaxed mb-6">
              For budgeting and planning, use the <Link to="/roof-cost-calculator" className="text-red-500 hover:text-red-400 underline">Lantana roof cost estimate</Link> and review <Link to="/easy-payments" className="text-red-500 hover:text-red-400 underline">financing options</Link>. Area coverage and related services are listed on the <Link to="/locations/lantana" className="text-red-500 hover:text-red-400 underline">Lantana service area hub</Link>.
            </p>
          </div>
        </div>
      </section>
