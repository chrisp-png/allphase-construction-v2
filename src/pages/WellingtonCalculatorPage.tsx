...
export default function WellingtonCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Wellington Roof Cost Calculator | All Phase Construction USA';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Wellington?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Wellington roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Wellington?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    ...
    {
      question: 'Are permits and code compliance included for Wellington roofs?',
      answer: "Permits and Florida Building Code compliance are required and can affect total roof cost."
    },
    {
      question: 'Can I estimate monthly payments for a roof in Wellington?',
  ...
  const costQuestions = [
    ...
    {
      question: 'Do roof prices increase after storms in Wellington?',
      answer: 'Yes. Labor demand, inspections, and material pricing often increase after major storms.'
    },
    {
      question: 'Does insurance affect roof replacement cost in Wellington?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/wellington/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Wellington
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div id="monthly-payment" className="mb-20 mt-20 scroll-mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Wellington?
            </h2>
          </div>
          ...
          <div id="finance-calculator" className="mb-20 scroll-mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Wellington roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Wellington
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Wellington Roof Cost Calculator
            </h2>
