  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <Helmet>
        ...
        <meta name="description" content="Top 5 best-rated roofers in Deerfield Beach, FL for 2026 — licensed, HVHZ-certified, and reviewed. See who made the list. Free quote: (754) 227-5605." />
      </Helmet>
