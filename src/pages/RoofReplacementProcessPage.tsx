...
export default function RoofReplacementProcessPage() {
  ...
  const roofingSystems: Array<{title: string; link: string; description: string; features: string[]}> = [
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we work with multiple financing partners to offer flexible payment options including zero-interest promotional periods, extended terms up to 20 years, same-day credit decisions, and no prepayment penalties. Many homeowners use insurance proceeds combined with <Link to="/easy-payments" className="text-zinc-500 hover:text-red-500 underline transition-colors">financing</Link> to upgrade to premium materials or cover deductibles.'
    },
    {
      question: 'What warranties come with a new roof?',
      answer: 'Every roof replacement includes multiple warranty layers: manufacturer material warranties (25-50 years depending on product), our workmanship warranty (10 years on installation), enhanced manufacturer warranties when we install full systems, permit-backed work guaranteed by the building department, and annual inspection eligibility for our maintenance program customers. We provide all warranty documentation at project completion and register products on your behalf. <Link to="/blog/understanding-your-roofing-warranty-whats-covered-and-whats-not" className="text-zinc-500 hover:text-red-500 underline transition-colors">Learn more about roofing warranties</Link>.'
    },
    {
      question: 'How do I know if I need roof replacement vs. repair?',
      answer: 'Roof replacement is typically recommended when: your roof is over 20 years old, you have widespread damage across multiple areas, repair costs exceed 30% of replacement cost, you\'re experiencing multiple leak locations, the roof failed a recent insurance inspection, or you\'re planning to sell within 5 years. We provide honest assessments and will recommend repairs when they make sense. A thorough <Link to="/roof-inspection" className="text-zinc-500 hover:text-red-500 underline transition-colors">roof inspection</Link> helps us give you accurate guidance on remaining service life. Check our <Link to="/roof-repair" className="text-zinc-500 hover:text-red-500 underline transition-colors">roof repair services</Link> for minor issues.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Material lifespan in South Florida depends on proper installation, maintenance, and exposure. <Link to="/tile-roofing" className="text-zinc-500 hover:text-red-500 underline transition-colors">Concrete and clay tile</Link> roofs last 50+ years when properly installed with HVHZ-compliant attachment. <Link to="/metal-roofing" className="text-zinc-500 hover:text-red-500 underline transition-colors">Metal roofing</Link> systems last 40-60 years with coastal-rated finishes. <Link to="/shingle-roofing" className="text-zinc-500 hover:text-red-500 underline transition-colors">Architectural shingles</Link> last 20-30 years—shorter than northern climates due to UV exposure and thermal cycling. Flat roof systems (TPO, EPDM) last 20-30 years with proper maintenance. All materials perform best with regular maintenance including annual inspections, debris removal, and prompt repair of minor issues. Wind mitigation features and proper ventilation extend lifespan regardless of material choice. We help you select materials based on your budget, home architecture, and long-term plans.'
    },
    {
    ...
    <>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-8 mb-12 max-w-4xl">
            ...
            <p className="text-base text-zinc-300 leading-relaxed">
              Replacing a roof in South Florida requires more than just removing old shingles and installing new ones. Every project must meet High Velocity Hurricane Zone (HVHZ) standards with engineered calculations, product approvals, <Link to="/blog/why-homeowners-should-avoid-pulling-their-own-roofing-permit-in-south-florida" className="text-zinc-400 hover:text-red-500 underline transition-colors">building permits</Link>, and municipal inspections. The process typically takes 4-6 weeks from initial inspection through final approval, with 3-7 days of active construction. Our 10-step system ensures code compliance, proper material selection, thorough documentation, and zero surprises—protecting your investment with permits, warranties, and third-party verification that standard contractors often skip.
            </p>
          </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-3 text-zinc-400">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                        <span><strong><Link to="/shingle-roofing" className="text-zinc-400 hover:text-red-500 transition-colors">Asphalt Shingles</Link>:</strong> Architectural, designer, or luxury lines with Class 3/4 impact ratings</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                        <span><strong><Link to="/tile-roofing" className="text-zinc-400 hover:text-red-500 transition-colors">Concrete Tile</Link>:</strong> S-tile, flat tile, or barrel tile in multiple colors</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                        <span><strong><Link to="/tile-roofing" className="text-zinc-400 hover:text-red-500 transition-colors">Clay Tile</Link>:</strong> Traditional Spanish S-tile and Mediterranean profiles</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                        <span><strong><Link to="/metal-roofing" className="text-zinc-400 hover:text-red-500 transition-colors">Metal Roofing</Link>:</strong> Standing seam, metal shingle, or corrugated options</span>
                      </li>
                    </ul>
                  </div>
                  <div>
            ...
            <div className="lg:col-span-9 space-y-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-10">
                ...
                <p className="text-sm text-zinc-500 mt-6">
                  ...
                  {' '}and{' '}
                  <Link to="/roof-maintenance-programs" className="text-zinc-400 hover:text-red-500 underline transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-10">
              ...
              <ul className="space-y-4 text-zinc-400">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed"><strong className="text-white"><Link to="/tile-roofing" className="text-white hover:text-red-500 transition-colors">Tile Roofs</Link>:</strong> Require foam adhesive and hurricane clips per NOA. Heavy weight (900-1200 lbs/square) necessitates structural verification.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed"><strong className="text-white"><Link to="/metal-roofing" className="text-white hover:text-red-500 transition-colors">Metal Roofs</Link>:</strong> Standing seam systems offer highest wind ratings (200+ mph). Require specialized fastening clips and thermal expansion provisions.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed"><strong className="text-white"><Link to="/shingle-roofing" className="text-white hover:text-red-500 transition-colors">Shingle Roofs</Link>:</strong> Architectural shingles with Class 3 or 4 impact ratings preferred. High-wind nail patterns (6 nails per shingle in perimeter zones).</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-10">
              ...
              <ul className="space-y-4 text-zinc-400">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed"><strong className="text-white"><Link to="/blog/wind-mitigation-for-south-florida-roofs-save-on-insurance-and-protect-your-home" className="text-white hover:text-red-500 transition-colors">Wind Mitigation Discounts</Link>:</strong> HVHZ-compliant installations qualify for 20-60% reductions in wind coverage premiums.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed"><strong className="text-white"><Link to="/blog/how-to-file-a-roof-insurance-claim-after-storm-damage" className="text-white hover:text-red-500 transition-colors">Claims Documentation</Link>:</strong> Proper installation with photos and permits protects your ability to file future storm damage claims.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {roofingSystems.map((system, index) => (
              <Link key={index} to={system.link} className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-red-900/50 transition-all duration-300 group">
                <h3 className="text-xl font-bold mb-4 group-hover:text-red-500 transition-colors">{system.title}</h3>
      ...
      <section className="py-32 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zinc-400">
              Helpful guides and resources for South Florida homeowners
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Link
              to="/blog/how-to-hire-a-roofer-in-south-florida-what-to-look-for-and-what-to-avoid"
              className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-red-900/50 transition-all group"
            >
              <h3 className="text-xl font-bold mb-4 group-hover:text-red-500 transition-colors">
                How to Hire a Roofer in South Florida
              </h3>
              <p className="text-zinc-400 text-sm leading-relaxed">
                What to look for, what to avoid, and red flags to watch out for.
              </p>
            </Link>

            <Link
              to="/blog/understanding-your-roofing-warranty-whats-covered-and-whats-not"
              className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-red-900/50 transition-all group"
            >
              <h3 className="text-xl font-bold mb-4 group-hover:text-red-500 transition-colors">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Manufacturer vs. workmanship warranties and what's actually covered.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Warning signs every homeowner should know before problems get expensive.
              </p>
            </Link>

            <Link
              to="/blog/wind-mitigation-for-south-florida-roofs-save-on-insurance-and-protect-your-home"
              className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-red-900/50 transition-all group"
            >
              <h3 className="text-xl font-bold mb-4 group-hover:text-red-500 transition-colors">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                How HVHZ-compliant roofs reduce your insurance premiums 20-60%.
              </p>
            </Link>

            <Link
              to="/blog/how-to-file-a-roof-insurance-claim-after-storm-damage"
              className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-red-900/50 transition-all group"
            >
              <h3 className="text-xl font-bold mb-4 group-hover:text-red-500 transition-colors">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Step-by-step guide to documenting damage and navigating the claims process.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Explore all roofing guides, resources, and educational content.
              </p>
            </Link>
          </div>
        </div>
      ...
      <section className="py-32 px-4 bg-gradient-to-b from-black via-red-950/10 to-black relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-zinc-400 mb-12">
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-5 h-5 text-red-500" />
          ...
          <p className="text-sm text-zinc-500 leading-relaxed">
            Serving{' '}
            <Link to="/locations/deerfield-beach" className="text-zinc-400 hover:text-red-500 transition-colors">Deerfield Beach</Link>,{' '}
            <Link to="/locations/boca-raton" className="text-zinc-400 hover:text-red-500 transition-colors">Boca Raton</Link>,{' '}
            <Link to="/locations/pompano-beach" className="text-zinc-400 hover:text-red-500 transition-colors">Pompano Beach</Link>,{' '}
            <Link to="/locations/boynton-beach" className="text-zinc-400 hover:text-red-500 transition-colors">Boynton Beach</Link>,{' '}
            <Link to="/locations/delray-beach" className="text-zinc-400 hover:text-red-500 transition-colors">Delray Beach</Link>,{' '}
            <Link to="/locations/fort-lauderdale" className="text-zinc-400 hover:text-red-500 transition-colors">Fort Lauderdale</Link>,{' '}
            <Link to="/locations/coral-springs" className="text-zinc-400 hover:text-red-500 transition-colors">Coral Springs</Link>, and communities throughout Broward and Palm Beach counties.
          </p>
        </div>
      </section>
    </div>
