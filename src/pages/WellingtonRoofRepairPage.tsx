...
export default function WellingtonRoofRepairPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'Roof Repair Wellington FL | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof repair services in Wellington, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof repair services in Wellington, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.';
  ...
  const faqItems = [
    {
      question: "How do I know if my Wellington roof needs repair or replacement?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Wellington?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Roof Repair in <span className="bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">Wellington, FL</span>
              </h1>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Wellington
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Wellington's suburban location concentrates weather-driven deterioration from seasonal storm patterns, wind-driven rain, and thermal cycling. Roof systems commonly exhibit wind-driven rain penetration at flashing and valley transitions, shingle lifting or fastener back-out from gust exposure and thermal movement, and UV-driven sealant failure around pipe boots, vents, and skylights. Tile cracking or slipped tiles from aging fasteners, hip and ridge mortar deterioration, granule loss on shingles from heat cycling, gutter and valley congestion leading to overflow, and drainage concerns on flat or low-slope patio and addition roofs are routinely identified during diagnostic inspections.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Wind gusts and thermal expansion cycles cause shingle tabs to lift and fasteners to back out, compromising wind resistance and requiring code-compliant fastening corrections during repair.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Intense UV exposure deteriorates sealants around pipe boots, vents, skylights, and satellite or solar stanchions where present, causing intermittent leaks that require component replacement and manufacturer-specified resealing.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Tile Cracking and Hip/Ridge Deterioration
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Aging fasteners, thermal movement, and foot traffic cause tiles to crack or slip, while hip and ridge mortar deteriorates over time, exposing underlayment to accelerated wear and requiring selective tile and ridge component replacement.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Gutter and Valley Congestion
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Debris accumulation in gutters and valleys creates overflow conditions that saturate fascia, soffit, and edge substrates, requiring clearance and targeted repairs to affected wood and flashing components.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Low-Slope Patio and Addition Drainage
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Flat and low-slope sections on patio covers and additions develop drainage restrictions and membrane fatigue from ponding water, accelerating wear and requiring drainage correction and localized membrane reinforcement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Wellington
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Wellington:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, hip and ridge component restoration, and flashing upgrades for concrete and clay tile systems prevalent across Wellington residential properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Membrane repairs, seam correction, and drainage improvements for modified bitumen, TPO, and other flat and low-slope systems on patio covers and residential additions. Repair techniques address both surface symptoms and underlying causal factors.
                </p>
                <p className="text-sm text-zinc-400 italic">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    Wellington homeowner associations maintain architectural control standards governing material selection, color matching, and installation methodology for visible roof repairs. Repair proposals require documentation demonstrating compliance with community aesthetic requirements.
                  </p>
                  <p>
                    We provide comprehensive submission packages including material specifications, manufacturer data sheets, color samples, and installation methodology descriptions addressing common HOA review criteria. Work scheduling and access coordination is routinely handled for HOA-governed properties and property manager requirements.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Wellington Cause</th>
                ...
                <tbody>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Ceiling staining after afternoon storms</td>
                    <td className="px-6 py-4 text-zinc-300">Wind-driven rain at wall flashing or step flashing</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Drips near bathroom vent stack</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Lifted or missing shingles at corners or edges</td>
                    ...
                    <td className="px-6 py-4 text-zinc-300">Replace damaged shingles and reinforce edge detailing as appropriate</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Cracked or slipped tiles along hips or ridges</td>
                    <td className="px-6 py-4 text-zinc-300">Movement, aging fasteners, or ridge component wear</td>
                    <td className="px-6 py-4 text-zinc-300">Underlayment exposure risk and accelerated wear</td>
                    <td className="px-6 py-4 text-zinc-300">Replace tiles and ridge pieces, inspect localized underlayment</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Overflow staining at fascia or soffit line</td>
                    <td className="px-6 py-4 text-zinc-300">Clogged valley or gutter runoff path restriction</td>
                    <td className="px-6 py-4 text-zinc-300">Wood rot and interior moisture risk from overflow</td>
                    <td className="px-6 py-4 text-zinc-300">Clear flow path, repair fascia/soffit damage, verify edge flashing</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Water marks near patio or flat roof transition</td>
                    <td className="px-6 py-4 text-zinc-300">Drainage restriction or seam fatigue at transition</td>
                    <td className="px-6 py-4 text-zinc-300">Recurring leaks at low-slope transition zones</td>
                    <td className="px-6 py-4 text-zinc-300">Reinforce membrane/transition flashing, improve drainage where warranted</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 text-zinc-300">Darkened decking spots in attic near penetration</td>
                    <td className="px-6 py-4 text-zinc-300">Slow leak at flashing or fastener penetration points</td>
                    <td className="px-6 py-4 text-zinc-300">Insulation saturation and concealed mold risk</td>
                    <td className="px-6 py-4 text-zinc-300">Targeted penetration re-flashing and localized deck review</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                ...
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Wellington properties.
                </p>
              </Link>

              <Link
                to="/service-areas/wellington/roof-cost-estimate"
                className="block bg-zinc-800 border-2 border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-all hover:shadow-lg hover:shadow-red-600/10 group"
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Roof Cost Estimate
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Wellington Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and flat/low-slope roof systems common to Wellington residential properties and additions.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Roof Repair FAQs – Wellington, FL
            </h2>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Wellington.
            </p>
