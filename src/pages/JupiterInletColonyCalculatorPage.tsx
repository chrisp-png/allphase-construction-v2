...
export default function JupiterInletColonyCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Jupiter Inlet Colony Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Jupiter Inlet Colony roof calculator. Instant HVHZ-compliant estimates for coastal properties. Tile, metal, shingle pricing. Licensed contractors. (754) 227-5605');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Jupiter Inlet Colony roof calculator. Instant HVHZ-compliant estimates for coastal properties. Tile, metal, shingle pricing. Licensed contractors. (754) 227-5605';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Jupiter Inlet Colony roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Jupiter Inlet Colony?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Jupiter Inlet Colony roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Jupiter Inlet Colony?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    {
      question: 'How accurate is the Jupiter Inlet Colony roof cost calculator?',
    ...
    {
      question: 'What factors affect roof cost in Jupiter Inlet Colony?',
    ...
    {
      question: 'Are permits and code compliance included for Jupiter Inlet Colony roofs?',
      answer: "Permits and Florida Building Code compliance are required and can affect total roof cost."
    },
    {
      question: 'Can I estimate monthly payments for a roof in Jupiter Inlet Colony?',
  ...
  const costQuestions = [
    {
      question: 'How much does a new roof cost in Jupiter Inlet Colony, FL?',
      answer: 'Most homes range from $15,000 to over $45,000 depending on roofing system and HVHZ requirements.'
    },
    {
      question: 'What is the cheapest roofing option in Jupiter Inlet Colony?',
      answer: 'Architectural shingles usually have the lowest upfront cost, though HVHZ standards can increase pricing.'
    },
    {
      question: "How long does a roof last in Jupiter Inlet Colony's climate?",
      answer: 'Shingle roofs average 15–20 years, while tile and metal roofs can last 30–50+ years.'
    },
    {
      question: 'Do roof prices increase after storms in Jupiter Inlet Colony?',
      answer: 'Yes. Coastal storm activity, labor demand, inspections, and material pricing often increase after major storms.'
    },
    {
      question: 'Does insurance affect roof replacement cost in Jupiter Inlet Colony?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/jupiter-inlet-colony/" className="text-zinc-400 hover:text-red-600 transition-colors">
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Estimates in Jupiter Inlet Colony by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Jupiter Inlet Colony, FL. Actual costs vary by roof size, slope, tear-off requirements, decking condition, and HVHZ code compliance.
            </p>
              ...
              <table className="w-full bg-[#27272a] border border-zinc-800 rounded-lg">
                ...
                <tbody>
                  <tr className="border-b border-zinc-800">
                    ...
                    <td className="px-6 py-4 text-zinc-300">$15,000 – $32,000+</td>
                  </tr>
                  <tr className="border-b border-zinc-800">
                  ...
                  <tr className="border-b border-zinc-800">
                    ...
                    <td className="px-6 py-4 text-zinc-300">$34,000 – $68,000+</td>
                  </tr>
                  <tr>
          ...
          <div id="monthly-payment" className="mb-20 mt-20 scroll-mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Jupiter Inlet Colony?
            </h2>
          </div>
          ...
          <div id="finance-calculator" className="mb-20 scroll-mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Jupiter Inlet Colony roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Jupiter Inlet Colony
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Jupiter Inlet Colony Roof Cost Calculator
            </h2>
