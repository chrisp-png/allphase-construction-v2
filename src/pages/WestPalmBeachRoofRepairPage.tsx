...
export default function WestPalmBeachRoofRepairPage() {
  ...
  const faqItems = [
    {
      question: "How do you decide between repair and replacement in West Palm Beach?",
      answer: "A diagnostic inspection evaluates damage extent, material condition, system age, and Florida Building Code thresholds to determine whether localized repair is feasible or broader work is warranted. Factors such as storm exposure, humidity-driven deterioration, and mixed roof system ages common to West Palm Beach properties are assessed where applicable."
    },
    {
      question: "Do roof repairs here have to meet Florida Building Code or HVHZ rules?",
      answer: "Yes. All roof repairs must comply with the Florida Building Code applicable to West Palm Beach at the time of work. High Velocity Hurricane Zone requirements apply where applicable, depending on location and project scope."
    },
    {
      question: "Can a tile roof in West Palm Beach usually be repaired without replacing the whole roof?",
      answer: "In many cases, yes. Individual tiles, localized underlayment sections, and flashing details can often be repaired if the surrounding system remains structurally sound and serviceable, though full conditions must be verified through inspection. Heat cycling and humidity common to West Palm Beach can accelerate underlayment aging."
    },
    {
      question: "How do you handle HOA requirements for roof repairs in West Palm Beach?",
      answer: "Many HOAs and condo associations in West Palm Beach require architectural review or approval for visible repairs. We routinely prepare submittal-ready documentation with scope notes, photos, and material specifications to support the review process."
    },
    {
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                <p>
                  West Palm Beach properties experience South Florida conditions that can accelerate roof wear, including sustained heat and UV cycling, seasonal storm exposure, high humidity, and wind-driven rain. Near-coastal exposure in certain neighborhoods may also influence material performance and longevity. All Phase Construction USA provides inspection-first roof repair services designed to identify root causes of leaks, tile displacement, or material failures before recommending corrective work. Every project begins with a <Link to="/roof-inspection" className="text-red-600 hover:text-red-500 underline transition-colors">diagnostic roof inspection</Link> to assess conditions under the Florida Building Code and determine whether targeted repair is appropriate for the observed issues, system age, and site exposure.
                </p>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in West Palm Beach
            </h2>
            <p className="text-lg text-zinc-300 mb-8 leading-relaxed">
              Roof systems in West Palm Beach commonly develop conditions influenced by storm exposure, humidity, heat cycling, and mixed roof ages:
            </p>
            ...
            <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8">
              <ul className="space-y-4 text-zinc-300">
                <li className="flex items-start gap-3">
                  ...
                  <span>Wind-driven rain entry at step flashing, wall transitions, and chimney or parapet details</span>
                </li>
                <li className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0 mt-1" />
                ...
                <li className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0 mt-1" />
                  <span>Shingle uplift, creasing, exposed fasteners, and missing tabs after high-wind events</span>
                </li>
                <li className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0 mt-1" />
                  <span>Flat or low-slope seam separation, edge detail wear, and drainage-related stress on addition roofs</span>
                </li>
                <li className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0 mt-1" />
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in West Palm Beach
            </h2>
            <p className="text-lg text-zinc-300 mb-8 leading-relaxed">
              All Phase Construction USA repairs a wide range of roofing systems commonly found in West Palm Beach's residential and commercial properties:
            </p>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 text-lg text-zinc-300 leading-relaxed">
              <p>
                Many properties in West Palm Beach's planned communities and condo associations fall under HOA governance with architectural review requirements. Our team routinely prepares repair documentation suitable for HOA submittal, including scope notes, photos, and material specifications. Coordination can also address scheduling constraints common in planned neighborhoods and association-specific standards where applicable.
              </p>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-zinc-300 mb-8 leading-relaxed">
              Use this table to understand common roof repair scenarios observed in West Palm Beach properties:
            </p>
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common West Palm Beach Cause</th>
                ...
                <tbody>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Ceiling stains after storms</td>
                    <td className="px-6 py-4 text-zinc-300">Wind-driven rain penetration at walls and valleys during seasonal storm events</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Underlayment aging beneath intact field tiles</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Flat or low-slope seam separation from seasonal storms and drainage stress</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 text-zinc-300">Shingle edge curling or tabs missing</td>
                    <td className="px-6 py-4 text-zinc-300">High-wind events and heat cycling common to mixed-age roof systems</td>
                    <td className="px-6 py-4 text-zinc-300">Compromises water-shedding performance and fastener exposure</td>
                    <td className="px-6 py-4 text-zinc-300">Shingle section replacement or reinforcement</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why West Palm Beach Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-white text-lg mb-2">Storm Exposure Assessment</h4>
                  <p className="text-zinc-300">Technical competence with South Florida climate considerations, including humidity effects, heat cycling, and seasonal storm patterns.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-white text-lg mb-2">Local Experience with Mixed Roof Systems</h4>
                  <p className="text-zinc-300">Understanding of tile, metal, flat, and shingle systems common to West Palm Beach properties of varying ages.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Roof Repair FAQs – West Palm Beach, FL
            </h2>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-6 max-w-2xl mx-auto leading-relaxed">
              If you're experiencing roof issues or want clarity before committing to major work, schedule a professional roof repair inspection with All Phase Construction USA. Our inspection-first approach helps West Palm Beach property owners understand options before making decisions.
            </p>
