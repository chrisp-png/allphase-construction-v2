          ...
          {JSON.stringify([
            {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": "https://allphaseconstructionfl.com/locations/palm-beach-gardens"
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": "Best Roofers in Palm Beach Gardens",
                  "item": "https://allphaseconstructionfl.com/locations/palm-beach-gardens/best-roofers-palm-beach-gardens"
                }
              ]
            },
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "How much does a new roof cost in Palm Beach Gardens?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Most residential roof replacements in Palm Beach Gardens range from $12,000 to $60,000+ depending on roof type, size, materials, and architectural complexity. HVHZ compliance, Palm Beach County permitting, and tile roof requirements in many upscale communities add cost that is unavoidable and non-negotiable for code-compliant work."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Do I need a permit for roofing work in Palm Beach Gardens / Palm Beach County?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes — virtually all roofing work in Palm Beach County requires a permit pulled by your licensed contractor. Additionally, many HOAs in Palm Beach Gardens require architectural approval before work begins. Your contractor must handle both entirely. If a roofer tells you permits aren't needed, that is a serious red flag."
                  }
                },
                {
                  "@type": "Question",
                  "name": "What is HVHZ and does it apply to Palm Beach Gardens?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "HVHZ stands for High Velocity Hurricane Zone. Palm Beach Gardens is in Palm Beach County HVHZ. Every roofing material and installation method must meet Florida Building Code Section 1504 wind resistance requirements and carry a Notice of Acceptance (NOA)."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Why do so many Palm Beach Gardens homes have barrel tile and concrete tile roofs?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Barrel tile and concrete tile are popular in upscale Palm Beach Gardens communities for their durability, aesthetic appeal, and superior wind performance in HVHZ zones. These materials are more expensive than asphalt shingles but provide better longevity — often 50+ years — and lower insurance costs due to their wind resistance."
                  }
                },
                {
                  "@type": "Question",
                ...
                {
                  "@type": "Question",
                  "name": "Will my HOA require architectural approval for a new roof?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Most likely yes. Palm Beach Gardens communities like PGA National, The Gardens, and Frenchman's Creek have strict HOA and architectural review boards. You must get approval before submitting permit applications. A qualified contractor will guide you through this process."
                  }
                }
              ]
            },
            {
              ...
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "1700 E Atlantic Blvd",
                "addressLocality": "Pompano Beach",
                "addressRegion": "FL",
                "postalCode": "33060",
                "addressCountry": "US"
              },
              "description": "Dual-licensed roofing and general contractor serving Palm Beach Gardens and Palm Beach County since 2005. Specializing in HVHZ-compliant roof systems, luxury tile installations, wind mitigation upgrades, and insurance premium reduction.",
              "areaServed": ["Palm Beach Gardens", "Palm Beach County", "Palm Beach County High Velocity Hurricane Zone"]
            }
          ])}
        </script>
      </Helmet>
