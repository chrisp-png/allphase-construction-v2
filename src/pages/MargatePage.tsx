            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-[#27272a] border border-zinc-800 rounded-lg p-8">
                <ul className="space-y-4 text-zinc-400">
                  <li>
                    <Link
                      to="/locations/deerfield-beach/service-area/margate/roof-cost-calculator"
                      className="text-red-500 hover:text-red-400 underline transition-colors"
                    >
                      https://allphaseconstructionfl.com/locations/deerfield-beach/service-area/margate/roof-cost-calculator
                    </Link>
                  </li>
                  <li>
                    <Link
                      to="/locations/deerfield-beach/service-area/margate/roof-cost-calculator#finance-calculator"
                      className="text-red-500 hover:text-red-400 underline transition-colors"
                    >
                      https://allphaseconstructionfl.com/locations/deerfield-beach/service-area/margate/roof-cost-calculator#finance-calculator
                    </Link>
                  </li>
                </ul>
              </div>
