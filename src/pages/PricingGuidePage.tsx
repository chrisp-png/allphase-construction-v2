        ...
        <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-neutral-950/10 backdrop-blur-sm border-2 border-[#C5A572] rounded-lg p-6">
        ...
        <section className="py-12 bg-neutral-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-blue-950/50 border-l-4 border-blue-500 p-6 mb-8">
        ...
        <section className="py-12 bg-gradient-to-br from-red-600 to-red-700">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-neutral-950/10 rounded-full mb-6">
              ...
              <Link
                to="/calculator/"
                className="inline-flex items-center gap-2 bg-neutral-950 text-red-600 px-8 py-4 rounded-lg font-semibold hover:bg-neutral-900 transition-all duration-300 shadow-lg text-lg"
              >
        ...
        <section className="py-12 bg-neutral-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mr-4">
                    <DollarSign className="w-6 h-6 text-red-600" />
                  </div>
                  <h3 className="text-lg font-bold text-white">Why Costs Are Higher</h3>
                </div>
              ...
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Average Costs by Material</h3>
                </div>
                <p className="text-gray-400">
              ...
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Ventilation & Airflow</h3>
                </div>
                <p className="text-gray-400">
              ...
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Wind Mitigation</h3>
                </div>
                <p className="text-gray-400">
              ...
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Installation Quality</h3>
                </div>
                <p className="text-gray-400">
              ...
              <div className="bg-neutral-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-neutral-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Financing Options</h3>
                </div>
                <p className="text-gray-400">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Contractor Licensing and Scope of Work</h3>
                ...
                {/* Subcontracting */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Subcontracting and Insurance Verification</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Workers Comp */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Workers' Compensation and Liability Coverage</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Crew Experience */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Crew Experience and Employee Retention</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Documentation */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Jobsite Safety and Documentation Practices</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Transparency */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Transparency and Access During Installation</h3>
                  <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-amber-950/50 border-l-4 border-amber-500 p-6 mt-8">
                <p className="text-gray-200 font-medium">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Standard Gooseneck Vents: Common but Limited</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Turbine Vents */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Turbine Vents: Widespread Use, Declining Performance</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Solar Attic Fans */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Solar Attic Fans: Effective When Properly Specified</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* HVHZ Requirements */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">High Velocity Hurricane Zone (HVHZ) Code Compliance</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Sizing and CFM */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Airflow Capacity and Proper Sizing</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Consequences of Inadequate or Incorrect Ventilation</h3>
                  <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-blue-950/50 border-l-4 border-blue-500 p-6 mt-8">
                <p className="text-gray-200 font-medium">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Florida Building Code and High Velocity Hurricane Zone Requirements</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Price Differences Reflect Installation Practice Variations</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">City Inspection Limitations and Quality Assurance Gaps</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Wind Mitigation Features and Insurance Premium Reductions</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Structural Repairs and General Contracting Capability</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Subcontracting Risk and Project Coordination Complexity</h3>
                  <p className="text-gray-300 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                {/* Crew Specialization */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Crew Specialization vs. General Labor</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Crew Tenure and Employee Retention</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Workers' Compensation Insurance and Jobsite Safety</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Extremely Low Bids and Hidden Cost Structures</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Internal Documentation and Quality Control Processes</h3>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Project Transparency and Progress Monitoring</h3>
                  <p className="text-gray-300 leading-relaxed">
        ...
        <section className="py-12 bg-neutral-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <article id="why-costs-higher">
              ...
              <div className="bg-neutral-900 rounded-lg p-8 border-l-4 border-red-600">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {faqData.map((faq, index) => (
                <div
                  key={index}
                  className="bg-neutral-950 border border-neutral-800 rounded-lg overflow-hidden hover:border-red-300 transition-all duration-200 shadow-sm hover:shadow-md"
                >
                  <button
        ...
        <section className="py-12 bg-gradient-to-br from-red-600 to-red-700 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link
              ...
              className="inline-block px-8 py-4 bg-neutral-950 text-red-600 rounded-lg font-bold text-lg hover:bg-neutral-800 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
