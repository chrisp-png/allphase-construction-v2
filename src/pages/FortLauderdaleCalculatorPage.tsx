...
export default function FortLauderdaleCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Fort Lauderdale Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Fort Lauderdale roofing projects. Final pricing depends on inspection, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Fort Lauderdale roofing projects. Final pricing depends on inspection, roof complexity, and material selection.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is this calculator exact?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. It provides a pricing range. Final numbers require inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What impacts roof cost in Fort Lauderdale?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Roof size, system type, complexity, and structural conditions."
          }
        },
        {
          "@type": "Question",
          "name": "Can I calculate financing here?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. The financing calculator estimates monthly payments."
          }
        }
      ]
    };
  ...
  const faqs = [
    {
      ...
      answer: "No. It provides a pricing range. Final numbers require inspection."
    },
    {
      question: 'What impacts roof cost in Fort Lauderdale?',
      answer: "Roof size, system type, complexity, and structural conditions."
    },
    {
      question: 'Can I calculate financing here?',
      answer: "Yes. The financing calculator estimates monthly payments."
    }
  ];
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/fort-lauderdale" className="text-zinc-400 hover:text-red-600 transition-colors">
              Fort Lauderdale
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-6 leading-relaxed">
              Use this roof cost calculator to get a fast ballpark estimate based on roof size and roof type. Final pricing depends on inspection findings and project complexity.
            </p>
          </div>
          ...
          <div className="mb-20 mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Fort Lauderdale roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Fort Lauderdale Roof Cost Calculator
            </h2>
