...
export default function SunriseRoofInspectionPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Sunrise FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Sunrise FL. Maximize insurance discounts and know if you need repair or replacement. Licensed & insured. Free inspection. Call 754 227-5605.';
  ...
  const faqs = [
    {
      question: 'How often should I inspect my roof in Sunrise?',
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-zinc-900 to-[#09090b]">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Roof Inspection Sunrise FL — <span className="text-red-500">Maximize Insurance Discounts & Protect Your Home</span>
          </h1>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Why Choose Our Sunrise Roof Inspection Service?</h2>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Common Roof Problems in Sunrise Homes</h2>
          <p className="text-zinc-400 mb-8">Sunrise homes face unique roofing challenges due to the subtropical climate &mdash; high winds, heavy rainfall, and intense sunlight. Here are the most common issues we find:</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: 'The combination of humidity and frequent rain creates ideal conditions for mold and algae to thrive on Sunrise roofs. These growths weaken roofing materials and lead to further damage if left untreated.',
              },
              {
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">What Makes Our Sunrise Roof Inspections Different?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
              ...
              },
              {
                ...
                body: 'Extensive experience identifying wind, hail, and water leak damage specific to South Florida storms, including subtle red flags that untrained eyes miss. We know what Sunrise’s weather does to roofs.',
              },
              {
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          ...
          <h3 className="text-xl font-semibold text-red-500 mb-4">Free Initial Roof Inspection for Sunrise Homeowners</h3>
          <p className="text-zinc-300 mb-6">
            We believe every homeowner deserves to know their roof's condition without financial barriers. That's why we offer a free roof inspection to residents throughout Sunrise and surrounding Broward County communities.
          </p>
          <p className="text-zinc-300 mb-8">
            Consider the math: The average roof replacement costs $8,000 to $20,000 for typical Sunrise homes. Meanwhile, targeted roof repairs often range from $500 to $5,000 depending on the issue. A thorough inspection ensures you're investing in the right solution.
          </p>
      ...
      <section className="py-16 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-white">Schedule Your Sunrise Roof Inspection Today</h2>
          ...
          <p className="text-zinc-400 mb-8 max-w-3xl mx-auto text-sm">
            We serve all Sunrise neighborhoods including Chapel Trail, Pembroke Falls, Silver Lakes, Nautica, Pines City Center, and properties along the Pembroke Road corridor near the western Broward edge.
          </p>
