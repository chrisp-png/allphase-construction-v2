  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <Helmet>
        ...
        <meta name="description" content="Top 5 best-rated roofers in Delray Beach, FL for 2026 — licensed, HVHZ-certified, and reviewed. See who made the list. Free quote: (754) 227-5605." />
      </Helmet>
          ...
          <div className="prose prose-invert prose-lg max-w-none mb-12">
            ...
            <ol className="space-y-4 list-decimal list-inside text-zinc-300">
              <li className="leading-relaxed">
                <strong className="text-white">All Phase Construction USA</strong> ⭐ 4.9 (160+ reviews) — #1 pick. Dual-licensed roofer + general contractor specializing in coastal salt-air protection and wind mitigation upgrades that lower your insurance premium. 20 years serving Delray Beach from Pompano Beach HQ.
              </li>
              <li className="leading-relaxed">
          ...
          <div className="prose prose-invert prose-lg max-w-none mb-16">
            ...
            <div className="border-l-4 border-red-600 bg-red-900/10 p-6 rounded-lg mb-12">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="text-lg text-yellow-400">⭐ 4.9 (160+ Google reviews)</span>
              </div>
              ...
              <p className="text-zinc-300 leading-relaxed mb-4">
                All Phase Construction USA is the #1 recommended roofer for Delray Beach homeowners — and rightfully so. With 20 years of continuous operation and 160+ verified Google reviews averaging 4.9 stars, this dual-licensed contractor combines roofing expertise (CCC1334109) with general construction authority (CGC1531823). This dual-licensing means they can legally handle both the roof installation and any structural issues discovered during the project — a significant advantage that single-licensed roofers cannot offer.
              </p>
      ...
      <section className="bg-gradient-to-br from-red-900 to-red-800 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="text-left max-w-3xl mx-auto mb-8 text-zinc-100">
            ...
            <p className="mb-4 leading-relaxed">
              If you want the contractor who does the most for your long-term protection — roof system, structure, insurance savings, and coastal salt-air expertise — <strong>All Phase Construction USA</strong> is the call to make. With 20 years of dual-licensed service and 160+ Google reviews, they're the clear #1 choice for Delray Beach's unique coastal challenges.
            </p>
