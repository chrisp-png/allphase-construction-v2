        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-20">
            <div className="bg-gradient-to-r from-blue-600/10 to-blue-500/10 border border-blue-600/20 rounded-2xl p-8 sm:p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/locations/deerfield-beach/service-area/sea-ranch-lakes/roof-cost-calculator"
                ...
                <Link
                  to="/locations/deerfield-beach/service-area/sea-ranch-lakes/roof-cost-calculator#finance-calculator"
