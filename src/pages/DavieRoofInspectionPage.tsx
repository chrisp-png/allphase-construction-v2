...
export default function DavieRoofInspectionPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Davie FL. Know if you need repair or replacement before spending thousands. Licensed & insured. Free inspection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Davie FL. Know if you need repair or replacement before spending thousands. Licensed & insured. Free inspection.';
