      ...
      <section className="py-16 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-4">
            ...
            <Link to="/commercial-roofing/" className="bg-zinc-800 p-5 rounded-xl hover:bg-zinc-700 transition-colors group">
              <h3 className="font-semibold text-white group-hover:text-red-500 transition-colors mb-1">Commercial Roofing</h3>
              <p className="text-sm text-zinc-400">Metal roofing solutions for commercial properties.</p>
            </Link>
            <Link to="/roof-repair/" className="bg-zinc-800 p-5 rounded-xl hover:bg-zinc-700 transition-colors group">
              ...
              <p className="text-sm text-zinc-400">Emergency and scheduled metal roof repairs.</p>
            </Link>
          </div>
        </div>
      </section>
