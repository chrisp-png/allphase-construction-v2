...
export default function MiramarPage() {
  ...
  useEffect(() => {
    document.title = 'Miramar Roofer | HVHZ Certified | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Miramar FL roofing contractor. HVHZ certified. Residential & commercial roofing. Tile, metal, shingle systems. Free inspections. (754) 227-5605');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Miramar FL roofing contractor. HVHZ certified. Residential & commercial roofing. Tile, metal, shingle systems. Free inspections. (754) 227-5605';
    ...
    const breadcrumbSchema = generateBreadcrumbSchema([
      ...
      { name: 'Miramar', url: 'https://allphaseconstructionfl.com/locations/deerfield-beach/service-area/miramar' }
    ]);
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How often should roofs in Miramar be inspected?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Roofs in Miramar should be inspected annually and after major storms to identify early signs of damage."
          }
        },
        {
          "@type": "Question",
          "name": "Are permits required for roofing work in Miramar?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, most roofing projects in Miramar require permits and inspections to meet Florida Building Code standards."
          }
        },
        {
          "@type": "Question",
          "name": "What roofing materials last longest in Miramar?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Metal and tile roofing systems typically provide the longest lifespan in Miramar due to their durability and wind resistance."
          }
        },
        {
          "@type": "Question",
          "name": "Can heavy rain cause roof leaks in Miramar even without visible damage?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const questions = [
    {
      question: 'Do you have a roofing office in Miramar?',
      answer: 'Our primary office is located in Deerfield Beach, and we provide full roofing service coverage throughout Miramar.'
    },
    {
      question: 'How fast can you respond to roof issues in Miramar?',
      answer: 'Our proximity allows for efficient response times and flexible scheduling.'
    },
    {
      question: 'Do you pull permits in Miramar?',
      answer: 'Yes. We handle permitting and coordinate inspections in accordance with local and state requirements.'
    },
    {
      question: 'What roofing systems work best in Miramar?',
      answer: 'Tile, metal, wind-rated shingle, and properly installed flat roofing systems perform well in Miramar conditions.'
    },
    {
      question: 'Are roof inspections free in Miramar?',
      answer: 'Yes. Free roof inspections are available for Miramar property owners.'
    }
  ];

  const faqs = [
    {
      question: 'How often should roofs in Miramar be inspected?',
      answer: 'Roofs in Miramar should be inspected annually and after major storms to identify early signs of damage.'
    },
    {
      question: 'Are permits required for roofing work in Miramar?',
      answer: 'Yes, most roofing projects in Miramar require permits and inspections to meet Florida Building Code standards.'
    },
    {
      question: 'What roofing materials last longest in Miramar?',
      answer: 'Metal and tile roofing systems typically provide the longest lifespan in Miramar due to their durability and wind resistance.'
    },
    {
      question: 'Can heavy rain cause roof leaks in Miramar even without visible damage?',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-8 leading-relaxed">
              All Phase Construction USA provides dependable roofing services throughout Miramar for residential and light commercial properties. From targeted roof repairs to full roof replacements, our team supports Miramar property owners with consistent service and technical oversight. Operating from our Deerfield Beach headquarters, we deliver roofing systems designed for South Florida weather exposure, durability, and Florida code compliance.
            </p>
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Your Trusted Roofing Services Team in Miramar
            </h2>
            <p className="text-zinc-400 leading-relaxed">
              Our roofing teams regularly work in Miramar with crews dispatched from our Deerfield Beach headquarters. This proximity allows for efficient scheduling and familiarity with Miramar permitting processes, inspection requirements, and Florida Building Code standards. Each project is completed with attention to wind resistance, moisture protection, and proper documentation.
            </p>
          </div>

          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roofing Conditions Unique to Miramar
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Roofing systems in Miramar are influenced by inland South Florida conditions that affect long-term performance:
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roofing Services for Miramar Properties
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              We provide a full range of roofing services tailored to Miramar properties:
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              What Miramar Roofs Commonly Face
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Property owners in Miramar often encounter roofing challenges such as:
            </p>
            <div className="max-w-4xl mx-auto bg-[#27272a] border border-zinc-800 rounded-lg p-8">
              <ul className="space-y-3 text-zinc-400 leading-relaxed">
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Roofing Questions from Miramar Homeowners
            </h2>
          ...
          <div className="bg-gradient-to-r from-red-600/10 to-red-500/10 border border-red-600/20 rounded-2xl p-8 sm:p-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Ready for Roofing Services in Miramar?
            </h2>
