...
export default function HaverillRoofRepairPage() {
  ...
  const faqItems = [
    {
      question: "How do I know if my Haverhill roof needs repair or replacement?",
    ...
    {
      question: "Do roof repairs in Haverhill have to meet Florida Building Code or HVHZ rules?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Haverhill?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
        ...
        {/* Common Haverhill Repair Problems */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Haverhill
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Haverhill roof systems experience inland Palm Beach County exposure conditions that include strong seasonal storm and wind-driven rain risk, heat and UV cycling degradation, and thermal stress from temperature fluctuations. Roof repair issues commonly include wind-driven rain intrusion at flashing, valleys, and wall transitions after seasonal storms, shingle lifting or creasing and fastener back-out from gusts and thermal movement, UV-driven sealant failure at pipe boots and penetrations, tile cracking or displacement from aging fasteners and underlayment wear where applicable, granule loss and brittle shingles from heat cycling, fascia and soffit staining from overflow at valleys and gutters where applicable, and drainage restrictions on low-slope patio and addition roofs causing ponding marks and membrane stress where present.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold text-white">
                    Wind-Driven Rain at Flashings and Wall Transitions
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Seasonal storm patterns drive rainfall through compromised step flashing, valley flashings, and wall transitions, requiring targeted flashing reconstruction to eliminate moisture pathways and prevent interior damage.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Gust forces combined with thermal movement cause shingle lifting, creasing, and fastener back-out, creating blow-off risk and exposed underlayment requiring shingle replacement and perimeter detailing reinforcement.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Prolonged UV exposure and thermal cycling deteriorate sealants around pipe boots, vents, skylights, and mounts where present, causing intermittent leaks that require component replacement and manufacturer-specified resealing.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Heat and UV cycling causes granule loss, brittle tabs, and increased crack susceptibility in shingle systems, requiring shingle replacement and evaluation of adjacent field condition to prevent widespread deterioration.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Fascia and Soffit Staining
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Overflow from valleys and gutters or edge detail fatigue causes fascia and soffit staining where applicable, creating wood rot and interior moisture risk requiring flow path clearance and edge detail repair.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Low-Slope Patio and Addition Drainage Issues
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Partial blockages or low-slope areas on patio and addition roofs where present cause ponding marks and accelerated membrane wear, requiring drainage clearance and localized membrane reinforcement at stress points.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA follows a structured diagnostic process before recommending any roof repair. The process begins with interior symptom review and moisture pattern mapping, followed by attic evaluation where accessible to assess staining, ventilation, and decking condition, exterior field survey by roof system type, and comprehensive documentation. Findings are reviewed against current Florida Building Code standards, including HVHZ considerations where applicable. Only repair scopes that can be completed without triggering unnecessary system-wide replacement are recommended, allowing property owners to make informed, code-aware decisions.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Inspection of attic staining patterns where accessible, including ventilation adequacy and decking condition, to identify concealed moisture travel and structural concerns requiring attention.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Comprehensive examination of roof surface conditions, material integrity, and visible damage patterns specific to shingle, tile, metal, or low-slope roof assemblies.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-3">
                      Detailed Inspection of Penetrations, Flashings, Valleys, and Edges
                    </h3>
                    <p className="text-zinc-300 leading-relaxed">
                      Assessment of flashings, penetrations, valleys, edge metal, and wall transitions where complexity increases leak potential and repair intervention is frequently needed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Inspection of drainage systems on any low-slope patio or addition sections, including scuppers, drains, slope adequacy, and ponding indicators where present.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Photographic documentation of conditions and preparation of measured repair scope suitable for HOA or community association review and insurance coordination where applicable.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Haverhill
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Haverhill:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, hip and ridge component restoration, and flashing upgrades for concrete and clay tile systems where present across Haverhill properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Membrane repairs, seam correction, termination verification, and drainage improvements for modified bitumen, TPO, and other flat and low-slope systems on patio and addition sections where present. Repair techniques address both surface symptoms and underlying causal factors including drainage restrictions.
                </p>
                <p className="text-sm text-zinc-400 italic">
                  Low-slope membrane repairs require proper drainage correction and edge termination verification to achieve long-term performance.
                </p>
              </div>
            </div>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Haverhill includes homeowner associations and community management oversight where applicable, with specific architectural standards and approval processes for roof repairs. All Phase Construction USA coordinates documentation, scope clarity, and material specifications to support HOA and community association compliance. When repairs involve insurance claims, inspection findings and photo documentation are provided to support the claim review process without offering legal or coverage determinations.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    HOAs and community associations where present maintain architectural control standards governing material selection, color matching, and installation methodology for visible roof repairs. Repair proposals require documentation demonstrating compliance with community aesthetic requirements.
                  </p>
                  <p>
                    We provide comprehensive submission packages including material specifications, manufacturer data sheets, color samples, and installation methodology descriptions addressing common review criteria. Work scheduling and access coordination is routinely handled for HOA-governed properties and community management requirements.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-lg p-8">
              ...
              <ul className="space-y-3 text-zinc-300">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-white">HOA/Community Submission Support:</strong> Material specifications and installation methodology for architectural review</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                  <span><strong className="text-white">Property Management:</strong> Coordinated scheduling and documentation for property managers where applicable</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Haverhill Cause</th>
                ...
                <tbody>
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Moisture migration into decking and insulation</td>
                    <td className="px-6 py-4 text-zinc-300">Targeted flashing reconstruction, reseal transitions</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                  ...
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Fascia or soffit staining at roof edge line</td>
                    <td className="px-6 py-4 text-zinc-300">Overflow from valleys or gutters, or edge detail fatigue</td>
                    <td className="px-6 py-4 text-zinc-300">Wood rot and interior moisture risk</td>
                    <td className="px-6 py-4 text-zinc-300">Clear flow paths, repair edge details, verify flashing</td>
                  </tr>
                  <tr>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Haverhill Roofing Services
                </h3>
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Haverhill properties.
                </p>
              </Link>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Haverhill Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Detailed photo documentation and measured repair scopes suitable for HOA or community association submissions and informed decision-making.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and low-slope roof systems common to Haverhill residential properties.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Proven experience coordinating with HOAs, community associations, and property managers to meet approval processes and scheduling requirements where applicable.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Haverhill.
            </p>
