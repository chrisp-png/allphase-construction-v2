...
export default function CooperCityRoofRepairPage() {
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);

  useEffect(() => {
    window.scrollTo(0, 0);

    document.title = 'Roof Repair Cooper City FL | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof repair services in Cooper City, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof repair services in Cooper City, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.';
  ...
  const faqItems = [
    {
      question: "How do I know if my Cooper City roof needs repair or replacement?",
    ...
    {
      question: "Do roof repairs in Cooper City have to meet Florida Building Code or HVHZ rules?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Cooper City?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Roof Repair in <span className="bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">Cooper City, FL</span>
              </h1>

              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                <p>
                  Cooper City is an inland Broward community characterized by strong seasonal storm exposure, intense wind-driven rain events, and sustained heat and UV cycling that stress roof systems across HOA-governed neighborhoods and varied housing stock. The city features a mix of asphalt shingle and tile roofs with occasional low-slope sections on patio additions, requiring repair strategies adapted to diverse system types and architectural control standards. All Phase Construction USA provides inspection-first roof repair in Cooper City, beginning with a <Link to="/roofing-services/roof-inspection" className="text-red-600 hover:text-red-500 underline transition-colors">diagnostic roof inspection</Link> to trace leak pathways, document moisture patterns, and determine whether targeted repairs meet Florida Building Code standards and HVHZ requirements where applicable. Learn more about <Link to="/service-areas/cooper-city" className="text-red-600 hover:text-red-500 underline transition-colors">roofing services in Cooper City</Link>, or use our <Link to="/service-areas/cooper-city/roof-cost-estimate" className="text-red-600 hover:text-red-500 underline transition-colors">roof cost calculator</Link> to estimate project scope. <Link to="/financing" className="text-red-600 hover:text-red-500 underline transition-colors">Flexible financing options</Link> are available.
                </p>
              </div>
        ...
        {/* Common Cooper City Repair Problems */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Cooper City
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Cooper City roof systems are exposed to intense seasonal storm patterns, wind-driven rain, and accelerated heat and UV deterioration characteristic of inland Broward settings. Roof repair issues commonly include wind-driven rain penetration at flashing and valley transitions after seasonal storms, shingle lifting or fastener back-out from gust exposure and thermal movement, UV-driven sealant failure at pipe boots and penetrations, granule loss and brittle shingles from prolonged heat cycling, tile cracking or displacement where applicable, fascia and soffit staining from overflow at valleys or gutter transitions, and drainage restrictions on low-slope patio or addition roofs leading to ponding and membrane stress.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Fascia and Soffit Staining at Roof Edges
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Overflow from valleys, gutters, or edge detail fatigue causes fascia and soffit staining with wood rot and interior moisture risk, requiring drainage clearance and edge detail repair.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Low-Slope Patio and Addition Roof Drainage
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Partial blockage or inadequate slope on patio and addition flat sections causes ponding and accelerated membrane wear, requiring drainage clearance and localized membrane reinforcement.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Inspection of scuppers, drains, slope adequacy, and ponding indicators on flat and low-slope patio or addition systems to identify drainage restrictions contributing to membrane stress.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Cooper City
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Cooper City:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, hip and ridge component restoration, and flashing upgrades for concrete and clay tile systems where present across Cooper City properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Membrane repairs, seam correction, and drainage improvements for modified bitumen, TPO, and other flat and low-slope systems on patio additions and covered outdoor living areas. Repair techniques address both surface symptoms and underlying causal factors.
                </p>
                <p className="text-sm text-zinc-400 italic">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    HOAs maintain architectural control standards governing material selection, color matching, and installation methodology for visible roof repairs. Repair proposals require documentation demonstrating compliance with community aesthetic requirements.
                  </p>
                  <p>
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Cooper City Cause</th>
                ...
                <tbody>
                  ...
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Granule piles in gutters and brittle tabs</td>
                    <td className="px-6 py-4 text-zinc-300">Heat and UV cycling aging shingles prematurely</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Wood rot and interior moisture risk at fascia attachment points</td>
                    <td className="px-6 py-4 text-zinc-300">Clear flow paths, repair edge details, verify flashing integrity</td>
                  </tr>
                  <tr>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Cooper City Roofing Services
                </h3>
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Cooper City properties.
                </p>
              </Link>

              <Link
                to="/service-areas/cooper-city/roof-cost-estimate"
                className="block bg-zinc-800 border-2 border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-all hover:shadow-lg hover:shadow-red-600/10 group"
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Roof Cost Estimate
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Cooper City Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and flat/low-slope roof systems common to Cooper City residential properties.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Roof Repair FAQs – Cooper City, FL
            </h2>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Cooper City.
            </p>
