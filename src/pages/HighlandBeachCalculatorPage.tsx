...
export default function HighlandBeachCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);
  const [openQuickFaq, setOpenQuickFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Highland Beach Roof Cost Calculator | All Phase';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Highland Beach roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The calculator provides a rough estimate based on typical Highland Beach homes. Final costs require an on-site inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Highland Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Highland Beach roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Highland Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const pricingData = [
    ...
    },
    {
      ...
      perSquare: '$1,200 – $1,800',
      totalRange: '$34,000 – $62,000'
    },
    {
      system: 'Flat / Low-Slope Roof',
      perSquare: '$600 – $950',
      totalRange: '$12,000 – $21,000'
    }
  ];

  const quickFaqs = [
    {
      question: 'How much does a new roof cost in Highland Beach, FL?',
      answer: 'Most homes range from $14,000 to over $40,000 depending on roof type and size.'
    },
    {
      question: 'What is the cheapest roofing option in Highland Beach?',
      answer: 'Architectural shingles usually have the lowest upfront cost.'
    },
    {
      question: 'How long does a roof last in Highland Beach\'s climate?',
      answer: 'Shingle roofs average 15–20 years, while tile and metal roofs can last 30–50+ years.'
    },
    {
      question: 'Do roof prices increase after storms in Highland Beach?',
      answer: 'Yes. Coastal storm activity often increases demand, inspections, and material pricing.'
    },
    {
      question: 'Does insurance affect roof replacement cost in Highland Beach?',
  ...
  const detailedFaqs = [
    {
      question: 'How accurate is the Highland Beach roof cost calculator?',
      answer: 'The calculator provides a rough estimate based on typical Highland Beach homes. Final costs require an on-site inspection.'
    },
    {
      question: 'What factors affect roof cost in Highland Beach?',
      answer: 'Roof size, material type, pitch, tear-off, decking repairs, and coastal wind-load codes affect pricing.'
    },
    {
      question: 'Are permits and code compliance included for Highland Beach roofs?',
      answer: 'Permits and Florida Building Code compliance are required and can impact total cost.'
    },
    {
      question: 'Can I estimate monthly payments for a roof in Highland Beach?',
      ...
      <div className="pt-36 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/highland-beach/" className="text-zinc-500 hover:text-white transition-colors">
              Highland Beach
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roof Cost Estimates in Highland Beach by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Highland Beach, FL. Actual costs vary by roof size, slope, tear-off needs, and Florida Building Code requirements.
            </p>
          ...
          <div id="monthly-payment" className="mb-20 scroll-mt-36">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Highland Beach?
            </h2>
            <div className="max-w-4xl mx-auto mb-12">
              <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-700/30 rounded-xl p-8 text-center">
                ...
                <p className="text-blue-100 mb-6 leading-relaxed">
                  Use the financing calculator below to estimate monthly payments for your roofing project in Highland Beach.
                </p>
              </div>
            </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Highland Beach
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Frequently Asked Questions – Highland Beach Roof Cost Calculator
            </h2>
            <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="bg-gradient-to-r from-red-600/10 to-red-500/10 border border-red-600/20 rounded-2xl p-8 sm:p-12 text-center">
            ...
            <p className="text-zinc-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              While our calculator provides helpful estimates, the best way to know your exact costs is with a free on-site inspection in Highland Beach.
            </p>
