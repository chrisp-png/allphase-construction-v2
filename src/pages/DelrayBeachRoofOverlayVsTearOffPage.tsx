  ...
  return (
    <>
      <SEO
        ...
        description="A contractor pitched a roof-over in Delray Beach? HVHZ code makes that nearly impossible — here is exactly why, with the code section that proves it."
