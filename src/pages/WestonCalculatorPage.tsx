...
export default function WestonCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Weston Roof Cost Calculator | All Phase Construction USA';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Weston roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Weston?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Weston roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Weston?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    {
      question: 'How accurate is the Weston roof cost calculator?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/weston" className="text-zinc-400 hover:text-red-600 transition-colors">
              Weston
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Estimates in Weston by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Weston, FL. Actual costs vary by roof size, slope, tear-off requirements, decking condition, and HVHZ code compliance.
            </p>
          ...
          <div id="monthly-payment" className="mb-20 mt-20 scroll-mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Weston?
            </h2>
          </div>
          ...
          <div id="finance-calculator" className="mb-20 scroll-mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Weston roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Weston Roof Cost Calculator
            </h2>
