...
export default function CoralSpringsCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Coral Springs Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Coral Springs roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Coral Springs roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What factors influence roof pricing in Coral Springs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Use the Coral Springs financing calculator above to estimate monthly payments."
          }
        }
      ]
    };
  ...
  const faqs = [
    ...
    {
      question: 'What factors influence roof pricing in Coral Springs?',
    ...
    },
    {
      ...
      answer: "Yes. Use the Coral Springs financing calculator above to estimate monthly payments."
    }
  ];
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/coral-springs/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Coral Springs
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Coral Springs roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Coral Springs?
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Coral Springs Roof Cost Calculator
            </h2>
