...
const FortLauderdaleRoofRepairPage = lazy(() => import('./FortLauderdaleRoofRepairPage'));
...
const LauderdaleLakesMoneyPage = lazy(() => import('./locations/LauderdaleLakesMoneyPage'));
...
const PalmBeachGardensMoneyPage = lazy(() => import('./locations/PalmBeachGardensMoneyPage'));
const ParklandMoneyPage = lazy(() => import('./locations/ParklandMoneyPage'));
...
const SouthwestRanchesMoneyPage = lazy(() => import('./locations/SouthwestRanchesMoneyPage'));
const NorthLauderdaleMoneyPage = lazy(() => import('./locations/NorthLauderdaleMoneyPage'));
const WiltonManorsMoneyPage = lazy(() => import('./locations/WiltonManorsMoneyPage'));
...
const locationPageMap: Record<string, React.LazyExoticComponent<() => JSX.Element>> = {
  ...
  'southwest-ranches': SouthwestRanchesMoneyPage,
  'north-lauderdale': NorthLauderdaleMoneyPage,
  'sunrise': SunriseMoneyPage,
  'tamarac': TamaracMoneyPage,
  'wellington': WellingtonPage,
  'west-palm-beach': WestPalmBeachMoneyPage,
  'wilton-manors': WiltonManorsMoneyPage,
};
...
const roofRepairPageMap: Record<string, React.LazyExoticComponent<() => JSX.Element>> = {
  ...
  'fort-lauderdale': FortLauderdaleRoofRepairPage,
