        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none mb-12">
            ...
            <p className="text-zinc-300 leading-relaxed mb-6">
              After researching dozens of roofing companies across Sunrise and Broward County, five rose to the top: <strong className="text-white">All Phase Construction USA</strong>, <strong className="text-white">Chase Roofing South Florida</strong>, <strong className="text-white">Roofing Recovery</strong>, <strong className="text-white">Sawgrass Roofing</strong>, and <strong className="text-white">Tip Top Roofing</strong>.
            </p>
          ...
          <div className="prose prose-invert prose-lg max-w-none mb-12">
            ...
            <ol className="space-y-4 list-decimal list-inside text-zinc-300">
              ...
              <li className="leading-relaxed">
                <strong className="text-white">Chase Roofing South Florida</strong> ⭐ 4.9 (450+ reviews) — High-rated Broward contractor specializing in residential and commercial roofing with responsive service and quality workmanship across Sunrise area. <a href="https://www.bbb.org" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 underline">BBB Accredited</a>
              </li>
              <li className="leading-relaxed">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-zinc-800">
                  ...
                  <tr>
                    <td className="px-4 py-4 font-medium text-white">Chase Roofing South Florida</td>
                    <td className="px-4 py-4 text-zinc-300">⭐ 4.9</td>
                    <td className="px-4 py-4 text-zinc-300">(954) 556-8900</td>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-zinc-800">
                  ...
                  <tr>
                    <td className="px-3 py-4 font-medium text-white">Chase Roofing South Florida</td>
                    <td className="px-3 py-4 text-zinc-300">⭐ 4.9</td>
                    <td className="px-3 py-4 text-zinc-300">(954) 556-8900</td>
                    ...
                    <td className="px-3 py-4 text-zinc-300">GAF Master Elite, Owens Corning Preferred, CertainTeed</td>
                    <td className="px-3 py-4 text-zinc-300">Responsive service, strong communication, Sunrise/Broward specialist</td>
                  </tr>
                  <tr>
          ...
          {/* Section 4: Chase Roofing South Florida */}
          <div className="bg-zinc-900 border-l-4 border-zinc-600 p-8 rounded-lg mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Chase Roofing South Florida — Sunrise, FL</h2>

            <div className="mb-6">
              <p className="text-xl text-yellow-500 font-semibold mb-4">⭐ 4.9 out of 5 (450+ reviews across platforms)</p>

              <blockquote className="border-l-4 border-zinc-700 pl-4 mb-4 italic text-zinc-300">
                "Chase Roofing was fantastic to work with. They came out quickly for inspection, gave us a detailed written estimate, and explained everything clearly. The crew was professional, worked efficiently, and the finished roof looks amazing. We were amazed at how responsive they were to our questions throughout the process."<br/>
                <span className="text-zinc-400 text-sm">— Google Review, Sunrise, FL</span>
              </blockquote>

              <blockquote className="border-l-4 border-zinc-700 pl-4 mb-4 italic text-zinc-300">
                "We called Chase for a storm damage repair and they came out same day. Their assessment was thorough, they worked directly with our insurance company, and the repair was done perfectly. The communication throughout was exceptional. This is a company that actually cares about customer satisfaction."<br/>
                <span className="text-zinc-400 text-sm">— HomeAdvisor Review</span>
              </blockquote>

              <blockquote className="border-l-4 border-zinc-700 pl-4 mb-6 italic text-zinc-300">
                "We had our entire Sunrise home roofed by Chase. Beyond the excellent workmanship, what impressed us most was their attention to HOA compliance and their willingness to get all approvals before starting work. They understood the complexities of our community's restrictions and delivered exactly what was promised. Highly recommended."<br/>
                <span className="text-zinc-400 text-sm">— Sunrise Homeowner Review</span>
              </blockquote>
            </div>

            <p className="text-zinc-300 leading-relaxed mb-4">
              Chase Roofing South Florida has been serving the Sunrise and Broward County area for 18 years with a reputation built on responsive service, quality workmanship, and customer satisfaction. Their 4.9 rating across Google, HomeAdvisor, and Angi reflects consistent delivery on promises and transparent communication throughout each project. Chase specializes in both residential and commercial roofing, making them a versatile choice for Sunrise's diverse property portfolio. They are known for their ability to navigate HOA approval processes and work efficiently around community restrictions — a major advantage in Sunrise's many planned communities. Their crew takes pride in leaving job sites clean and in finishing projects on schedule.
            </p>

            <h3 className="text-xl font-bold text-white mt-6 mb-3">Services:</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
              Residential and commercial roof repair and replacement, asphalt shingle systems, concrete and clay tile roofing, metal roofing, flat roof systems (TPO, EPDM, PVC, modified bitumen), roof restorations and coatings, emergency repairs, free roof inspections, insurance claim assistance, storm damage assessment and coordination.
            </p>

            <h3 className="text-xl font-bold text-white mt-6 mb-3">Standouts:</h3>
            <p className="text-zinc-300 leading-relaxed mb-6">
              GAF Master Elite Contractor | Owens Corning Preferred Partner | CertainTeed Certified | 4.9 Google rating across 450+ reviews | BBB Accredited with A+ rating | Specialized HOA experience | Same-day emergency response | 25-year material warranties available | Professional crew training and certification
            </p>

            <div className="flex flex-wrap gap-4 items-center text-zinc-300">
              <span className="flex items-center gap-2">
                <Phone className="w-5 h-5 text-red-500" />
                <strong>(954) 556-8900</strong>
              </span>
              <span>|</span>
              <a href="https://www.chaseroofingsouthflorida.com" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 underline">chaseroofingsouthflorida.com</a>
              <span>|</span>
              <span className="flex items-center gap-2">
                <MapPin className="w-5 h-5 text-red-500" />
                Sunrise, FL Service Area
              </span>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-br from-red-900 to-red-800 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="text-left max-w-3xl mx-auto mb-8 text-zinc-100">
            ...
            <p className="mb-4 leading-relaxed">
              If you want a responsive, high-rated Broward contractor with strong HOA experience and excellent communication, <strong>Chase Roofing South Florida</strong> is worth every minute of your call.
            </p>
