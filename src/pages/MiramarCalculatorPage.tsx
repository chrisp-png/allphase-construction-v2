...
export default function MiramarCalculatorPage() {
  const [openQuestion, setOpenQuestion] = useState<number | null>(null);
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Miramar Roof Cost Calculator | All Phase Construction USA';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Miramar roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Miramar roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Miramar roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The calculator provides a rough estimate based on typical Miramar homes. Final costs require an on-site inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Miramar?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Miramar roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Miramar?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    {
      question: 'How accurate is the Miramar roof cost calculator?',
      answer: 'The calculator provides a rough estimate based on typical Miramar homes. Final costs require an on-site inspection.'
    },
    {
      question: 'What factors affect roof cost in Miramar?',
      answer: 'Roof size, material type, pitch, tear-off, decking repairs, and hurricane wind-load codes affect pricing.'
    },
    {
      question: 'Are permits and code compliance included for Miramar roofs?',
      answer: 'Permits and Florida Building Code compliance are required and can impact total cost.'
    },
    {
      question: 'Can I estimate monthly payments for a roof in Miramar?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/miramar/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Miramar
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-6 leading-relaxed">
              Use this calculator for a ballpark estimate only. Roof pricing in South Florida varies due to hurricane wind requirements, material availability, and roof design. Estimates are not guarantees.
            </p>
          </div>
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roof Cost Estimates in Miramar by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Miramar, FL. Actual costs vary by roof size, slope, tear-off needs, and Florida Building Code requirements.
            </p>
          ...
          <div className="mb-20" id="monthly-payment">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Miramar?
            </h2>
            ...
            <div id="finance-calculator" className="mb-8">
              <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
                Estimate monthly payments for your Miramar roof using financing options.
              </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Roof Cost Questions in Miramar
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Miramar Roof Cost Calculator
            </h2>
            <div className="max-w-4xl mx-auto space-y-4">
              {faqs.map((faq, index) => (
                <div
