    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="py-20 bg-zinc-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 text-lg text-zinc-300 leading-relaxed">
            <p>
              All Phase Construction USA provides professional tile roof inspection services throughout Broward County, including <Link to="/locations/fort-lauderdale" className="text-red-500 hover:text-red-400 underline transition-colors">Fort Lauderdale</Link>, <Link to="/locations/coral-springs" className="text-red-500 hover:text-red-400 underline transition-colors">Coral Springs</Link>, <Link to="/locations/pompano-beach" className="text-red-500 hover:text-red-400 underline transition-colors">Pompano Beach</Link>, Deerfield Beach, <Link to="/locations/plantation" className="text-red-500 hover:text-red-400 underline transition-colors">Plantation</Link>, Hollywood, <Link to="/locations/davie" className="text-red-500 hover:text-red-400 underline transition-colors">Davie</Link>, Weston, Pembroke Pines, Miramar, and all surrounding communities.
            </p>
