...
export default function PembrokePinesCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Pembroke Pines Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Pembroke Pines roof calculator. HVHZ-compliant estimates. Tile, metal, shingle pricing. Licensed Broward contractor. Call (754) 227-5605');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Pembroke Pines roof calculator. HVHZ-compliant estimates. Tile, metal, shingle pricing. Licensed Broward contractor. Call (754) 227-5605';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Pembroke Pines roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Pembroke Pines?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Pembroke Pines roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Pembroke Pines?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    {
      question: 'How accurate is the Pembroke Pines roof cost calculator?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/pembroke-pines/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Pembroke Pines
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Estimates in Pembroke Pines by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Pembroke Pines, FL. Actual costs vary by roof size, slope, tear-off requirements, decking condition, and HVHZ code compliance.
            </p>
          ...
          <div id="monthly-payment" className="mb-20 mt-20 scroll-mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Pembroke Pines?
            </h2>
          </div>
          ...
          <div id="finance-calculator" className="mb-20 scroll-mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Pembroke Pines roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Pembroke Pines
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Pembroke Pines Roof Cost Calculator
            </h2>
