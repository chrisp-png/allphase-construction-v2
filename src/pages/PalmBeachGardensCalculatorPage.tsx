...
export default function PalmBeachGardensCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Palm Beach Gardens Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Palm Beach Gardens roof calculator. Instant HVHZ-compliant estimates. Tile, metal, shingle pricing. Licensed contractors. Call (754) 227-5605');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Palm Beach Gardens roof calculator. Instant HVHZ-compliant estimates. Tile, metal, shingle pricing. Licensed contractors. Call (754) 227-5605';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Palm Beach Gardens roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Palm Beach Gardens?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Palm Beach Gardens roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Palm Beach Gardens?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const faqs = [
    {
      question: 'How accurate is the Palm Beach Gardens roof cost calculator?',
    ...
    {
      question: 'What factors affect roof cost in Palm Beach Gardens?',
      answer: "Roof size, material choice, pitch, tear-off needs, decking repairs, and Florida wind-load codes all impact pricing."
    },
    {
      question: 'Are permits and code compliance included for Palm Beach Gardens roofs?',
      answer: "Permits and Florida Building Code compliance are required and can affect total roof cost."
    },
    {
      question: 'Can I estimate monthly payments for a roof in Palm Beach Gardens?',
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/palm-beach-gardens/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Palm Beach Gardens
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Estimates in Palm Beach Gardens by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Palm Beach Gardens, FL. Actual costs vary by roof size, slope, tear-off requirements, decking condition, and HVHZ code compliance.
            </p>
          ...
          <div id="monthly-payment" className="mb-20 mt-20 scroll-mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Palm Beach Gardens?
            </h2>
          </div>
          ...
          <div id="finance-calculator" className="mb-20 scroll-mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Palm Beach Gardens roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Palm Beach Gardens
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Palm Beach Gardens Roof Cost Calculator
            </h2>
