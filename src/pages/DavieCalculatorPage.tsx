...
export default function DavieCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Davie Roof Cost Calculator | All Phase Construction USA';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Davie roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Davie roofing projects. Final pricing depends on inspection results, roof complexity, and material selection.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What factors influence roof pricing in Davie?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Use the Davie financing calculator above to estimate monthly payments."
          }
        }
      ]
    };
  ...
  const faqs = [
    ...
    {
      question: 'What factors influence roof pricing in Davie?',
    ...
    },
    {
      ...
      answer: "Yes. Use the Davie financing calculator above to estimate monthly payments."
    }
  ];
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/davie" className="text-zinc-400 hover:text-red-600 transition-colors">
              Davie
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20" id="finance-calculator">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Davie roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Davie?
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Davie Roof Cost Calculator
            </h2>
