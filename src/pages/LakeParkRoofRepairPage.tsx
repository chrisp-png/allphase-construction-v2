        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-zinc-900 p-8 rounded-lg border border-zinc-800 mb-8">
            ...
            <p className="text-zinc-300 leading-relaxed mt-6">
              For more information on <Link to="/locations/lake-park" className="text-red-500 hover:text-red-400 underline">service area coverage in Lake Park</Link>, visit the local service area hub.
            </p>
          </div>
          ...
          <div className="bg-zinc-950 p-8 rounded-lg border border-zinc-800">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3 text-zinc-300">
                ...
                <span>Get a preliminary <Link to="/roof-cost-calculator" className="text-red-500 hover:text-red-400 underline">roof cost estimate</Link> based on your Lake Park property details and repair scope.</span>
              </li>
              <li className="flex gap-3 text-zinc-300">
                <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-0.5" />
                <span>Review available <Link to="/easy-payments" className="text-red-500 hover:text-red-400 underline">easy payment options</Link> to manage repair costs with flexible financing plans.</span>
              </li>
              <li className="flex gap-3 text-zinc-300">
                <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-0.5" />
                <span>Additional coverage details are available on the <Link to="/locations/lake-park" className="text-red-500 hover:text-red-400 underline">Lake Park service area hub</Link>.</span>
              </li>
            </ul>
          </div>
        </div>
