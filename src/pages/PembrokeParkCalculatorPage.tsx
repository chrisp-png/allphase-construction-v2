...
export default function PembrokeParkCalculatorPage() {
  ...
  const faqs = [
    {
      question: 'How accurate is the Pembroke Park roof cost calculator?',
      answer: 'The calculator provides a rough estimate based on typical Pembroke Park homes. Final pricing requires an on-site inspection.'
    },
    {
      question: 'What factors affect roof cost in Pembroke Park?',
      answer: 'Roof size, material choice, pitch, tear-off, decking repairs, and Florida wind-load codes affect cost.'
    },
    {
      question: 'Are permits and code compliance included for Pembroke Park roofs?',
      answer: 'Permits and Florida Building Code compliance are required and can impact total pricing.'
    },
    {
      question: 'Can I estimate monthly payments for a roof in Pembroke Park?',
  ...
  return (
    <div className="min-h-screen bg-[#09090b]">
      <Helmet>
        <title>Pembroke Park Roof Cost Calculator | All Phase Construction USA</title>
        <meta
          name="description"
          content="Use this roof cost calculator to get a fast ballpark estimate for Pembroke Park roofing projects. Final pricing depends on inspection results, roof complexity, and material selection."
        />
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/pembroke-park" className="text-zinc-400 hover:text-red-600 transition-colors">
              Pembroke Park
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="mb-20 mt-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roof Cost Estimates in Pembroke Park by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Pembroke Park, FL. Actual costs vary by roof size, slope, tear-off needs, and Florida Building Code requirements.
            </p>
          ...
          <div className="mb-20" id="monthly-payment">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Pembroke Park?
            </h2>
            ...
            <div id="finance-calculator" className="mb-8">
              <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
                Estimate monthly payments for your Pembroke Park roof using financing options.
              </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Roof Cost Questions in Pembroke Park
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Pembroke Park Roof Cost Calculator
            </h2>
            <div className="max-w-4xl mx-auto space-y-4">
              {faqs.map((faq, index) => (
                <div
