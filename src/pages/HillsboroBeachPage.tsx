...
export default function HillsboroBeachPage() {
  const [openQuestion, setOpenQuestion] = useState<number | null>(null);
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Hillsboro Beach Roofer | HVHZ Certified | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Hillsboro Beach FL roofing contractor. HVHZ certified. Tile, metal, shingle systems. Free inspections. (754) 227-5605');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Hillsboro Beach FL roofing contractor. HVHZ certified. Tile, metal, shingle systems. Free inspections. (754) 227-5605';
      document.head.appendChild(meta);
    }

    const coordinates = getCityCoordinates('Hillsboro Beach');
    const localBusinessSchema = generateLocalBusinessSchema({
      cityName: 'Hillsboro Beach',
      stateName: 'Florida',
    ...
    const breadcrumbSchema = generateBreadcrumbSchema([
      ...
      { name: 'Hillsboro Beach', url: 'https://allphaseconstructionfl.com/locations/deerfield-beach/service-area/hillsboro-beach' }
    ]);
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How often should roofs in Hillsboro Beach be inspected?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Roofs in Hillsboro Beach should be inspected annually and after major coastal storms to identify early signs of damage."
          }
        },
        {
          "@type": "Question",
          "name": "Are permits required for roofing work in Hillsboro Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, most roofing projects in Hillsboro Beach require permits and inspections to meet Florida Building Code standards."
          }
        },
        {
          "@type": "Question",
          "name": "What roofing materials last longest in Hillsboro Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Metal and tile roofing systems typically provide the longest lifespan in Hillsboro Beach due to their resistance to wind, salt, and UV exposure."
          }
        },
        {
          "@type": "Question",
          "name": "Can salt air affect roof lifespan in Hillsboro Beach?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const roofingConditions = [
    {
      ...
      description: 'from tropical systems and seasonal storms'
    },
    {
    ...
    },
    {
      ...
      description: 'increasing corrosion and fastener wear'
    },
    {
  ...
  const questions = [
    {
      question: 'Do you have a roofing office in Hillsboro Beach?',
      answer: 'Our primary office is located in Deerfield Beach, and we provide full roofing service coverage throughout Hillsboro Beach.'
    },
    {
      question: 'How fast can you respond to roof issues in Hillsboro Beach?',
      answer: 'Our proximity allows for efficient response times and flexible scheduling.'
    },
    {
      question: 'Do you pull permits in Hillsboro Beach?',
      answer: 'Yes. We handle permitting and coordinate inspections in accordance with local and state requirements.'
    },
    {
      question: 'What roofing systems work best in Hillsboro Beach?',
      answer: 'Metal, tile, wind-rated shingle, and properly installed flat roofing systems perform well in coastal conditions.'
    },
    {
      question: 'Are roof inspections free in Hillsboro Beach?',
      answer: 'Yes. Free roof inspections are available for Hillsboro Beach property owners.'
    }
  ];

  const faqs = [
    {
      question: 'How often should roofs in Hillsboro Beach be inspected?',
      answer: 'Roofs in Hillsboro Beach should be inspected annually and after major coastal storms to identify early signs of damage.'
    },
    {
      question: 'Are permits required for roofing work in Hillsboro Beach?',
      answer: 'Yes, most roofing projects in Hillsboro Beach require permits and inspections to meet Florida Building Code standards.'
    },
    {
      question: 'What roofing materials last longest in Hillsboro Beach?',
      answer: 'Metal and tile roofing systems typically provide the longest lifespan in Hillsboro Beach due to their resistance to wind, salt, and UV exposure.'
    },
    {
      question: 'Can salt air affect roof lifespan in Hillsboro Beach?',
      ...
      <div className="pt-36 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <span className="text-white">Hillsboro Beach</span>
          </nav>
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-zinc-400 mb-8 leading-relaxed">
              All Phase Construction USA provides professional roofing services throughout Hillsboro Beach for residential and coastal properties. From targeted roof repairs to full system replacements, our team supports Hillsboro Beach property owners with consistent service and technical oversight. Operating from our Deerfield Beach headquarters, we deliver roofing solutions engineered for coastal exposure, long-term durability, and Florida code compliance.
            </p>
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Your Trusted Roofing Services Team in Hillsboro Beach
            </h2>
            <div className="space-y-4 text-zinc-400 leading-relaxed">
              <p>
                Our roofing teams regularly serve Hillsboro Beach from our Deerfield Beach location, allowing for efficient scheduling and direct on-site supervision. This proximity supports familiarity with Hillsboro Beach permitting processes, inspection requirements, and Florida Building Code standards. Each roofing project is completed with attention to wind mitigation, moisture control, and proper documentation.
              </p>
            </div>
          </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roofing Conditions Unique to Hillsboro Beach
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Roofing systems in Hillsboro Beach face demanding coastal environmental conditions that influence material selection and installation methods:
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roofing Services for Hillsboro Beach Properties
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              We provide a full range of roofing services tailored to Hillsboro Beach properties:
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              What Hillsboro Beach Roofs Commonly Face
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Property owners in Hillsboro Beach often encounter roofing challenges such as:
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Why Hillsboro Beach Homeowners Choose All Phase Construction USA
            </h2>
            <div className="max-w-3xl mx-auto bg-[#27272a] border border-zinc-800 rounded-lg p-8">
              <ul className="space-y-4">
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roof Cost Tools for Hillsboro Beach
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
            ...
            <div className="max-w-2xl mx-auto space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-white mb-1 group-hover:text-red-500 transition-colors">
                      Hillsboro Beach Roof Cost Calculator
                    </h3>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-white mb-1 group-hover:text-red-500 transition-colors">
                      Hillsboro Beach Roof Financing Calculator
                    </h3>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roofing Questions from Hillsboro Beach Homeowners
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roofing FAQs for Hillsboro Beach
            </h2>
            <div className="max-w-4xl mx-auto space-y-4">
              {faqs.map((faq, index) => (
                <div
          ...
          <div className="bg-gradient-to-r from-red-600/10 to-red-500/10 border border-red-600/20 rounded-2xl p-8 sm:p-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Ready for Roofing Services in Hillsboro Beach?
            </h2>
