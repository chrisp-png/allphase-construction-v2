            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                ...
                <p className="text-base">
                  Service area resources: <Link to="/service-areas/coral-springs" className="text-red-600 hover:text-red-500 underline transition-colors">Coral Springs service area</Link> • <Link to="/locations/deerfield-beach/service-area/coral-springs/roof-cost-calculator" className="text-red-600 hover:text-red-500 underline transition-colors">Coral Springs roof cost estimate</Link> • <Link to="/easy-payments" className="text-red-600 hover:text-red-500 underline transition-colors">financing options</Link>
                </p>
              </div>
