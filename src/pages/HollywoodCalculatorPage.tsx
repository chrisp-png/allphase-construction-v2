...
export default function HollywoodCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);
  const [openQuickFaq, setOpenQuickFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Hollywood Roof Cost Calculator | All Phase Construction USA';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this calculator for a ballpark estimate only. Roof pricing in South Florida varies due to hurricane wind requirements, coastal weather, and material availability. Estimates are not guarantees.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this calculator for a ballpark estimate only. Roof pricing in South Florida varies due to hurricane wind requirements, coastal weather, and material availability. Estimates are not guarantees.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How accurate is the Hollywood roof cost calculator?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The calculator provides a rough estimate based on typical Hollywood homes. Final costs require an on-site inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What factors affect roof cost in Hollywood?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are permits and code compliance included for Hollywood roofs?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can I estimate monthly payments for a roof in Hollywood?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const quickFaqs = [
    ...
    {
      question: 'What is the cheapest roofing option in Hollywood?',
      answer: 'Architectural shingles usually have the lowest upfront cost.'
    },
    {
      question: 'How long does a roof last in Hollywood\'s climate?',
      answer: 'Shingle roofs average 15–20 years, while tile and metal roofs can last 30–50+ years.'
    },
    {
      question: 'Do roof prices increase after storms in Hollywood?',
      answer: 'Yes. Post-storm demand, inspections, and material costs often increase pricing.'
    },
    {
      question: 'Does insurance affect roof replacement cost in Hollywood?',
  ...
  const detailedFaqs = [
    {
      question: 'How accurate is the Hollywood roof cost calculator?',
      answer: 'The calculator provides a rough estimate based on typical Hollywood homes. Final costs require an on-site inspection.'
    },
    {
      question: 'What factors affect roof cost in Hollywood?',
      answer: 'Roof size, material type, pitch, tear-off, decking repairs, and hurricane wind-load codes affect pricing.'
    },
    {
      question: 'Are permits and code compliance included for Hollywood roofs?',
      answer: 'Permits and Florida Building Code compliance are required and can impact total cost.'
    },
    {
      question: 'Can I estimate monthly payments for a roof in Hollywood?',
      ...
      <div className="pt-36 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/hollywood/" className="text-zinc-500 hover:text-white transition-colors">
              Hollywood
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-lg text-zinc-400 mb-4 leading-relaxed">
              Use this calculator for a ballpark estimate only. Roof pricing in South Florida varies due to hurricane wind requirements, coastal weather, and material availability. Estimates are not guarantees.
            </p>
          </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              Roof Cost Estimates in Hollywood by Roofing System
            </h2>
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              These are typical installed price ranges for homes in Hollywood, FL. Actual costs vary by roof size, slope, tear-off needs, and Florida Building Code requirements.
            </p>
          ...
          <div id="monthly-payment" className="mb-20 scroll-mt-36">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Hollywood?
            </h2>
            <div className="max-w-4xl mx-auto mb-12">
              <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-700/30 rounded-xl p-8 text-center">
                ...
                <p className="text-blue-100 mb-6 leading-relaxed">
                  Use the financing calculator below to estimate monthly payments for your roofing project in Hollywood.
                </p>
              </div>
            </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Roof Cost Questions in Hollywood
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 text-center">
              Frequently Asked Questions – Hollywood Roof Cost Calculator
            </h2>
            <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="bg-gradient-to-r from-red-600/10 to-red-500/10 border border-red-600/20 rounded-2xl p-8 sm:p-12 text-center">
            ...
            <p className="text-zinc-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              While our calculator provides helpful estimates, the best way to know your exact costs is with a free on-site inspection in Hollywood.
            </p>
