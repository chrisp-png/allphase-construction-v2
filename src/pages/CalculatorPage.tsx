...
export default function CalculatorPage() {
  ...
  // FAQ schema for /roof-cost-calculator now lives in
  // SERVICE_PAGE_SCHEMAS['/roof-cost-calculator'].faqs in
  // scripts/prerender-static.mjs (PR-29). Generated at build time so
  // Google sees the FAQPage on initial crawl rather than only via
  // post-hydration JS execution. See CLAUDE.md §6 + §9.
