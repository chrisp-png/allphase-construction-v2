    ...
    <><div className="min-h-screen bg-black">
      ...
      <section className="py-16 bg-black px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* PR-223: hydrated mirror of the prerendered metal cost section (PR-215) */}
          <h2 className="text-2xl font-bold text-white mb-4">Metal Roof Cost in South Florida (2026)</h2>
          <p className="text-zinc-300 leading-relaxed mb-6">
            Searching for a straight answer on metal roof cost? Here it is. Metal roofing in Broward and Palm Beach County runs <strong className="text-white">$8 to $25 per square foot installed</strong>, depending on the system: snap-lock steel panels at roughly <strong className="text-white">$8–$13/sq ft</strong>, mechanically seamed steel or aluminum with a Kynar finish at roughly <strong className="text-white">$12–$19/sq ft</strong>, and premium mechanically seamed aluminum at roughly <strong className="text-white">$18–$25/sq ft</strong>. For most South Florida homes that puts a complete metal roof between <strong className="text-white">$15,000 and $45,000 installed</strong> — larger homes and premium aluminum systems run higher. Near the coast, aluminum is worth the step up: it will not rust in salt air the way steel can. The calculator below prices metal side-by-side with shingle, tile, and flat systems for your actual roof size, and our <Link to="/metal-roofing/" className="text-white font-semibold hover:text-zinc-100 underline">metal roofing guide</Link> covers the engineering — seam types, clip spacing, gauge, and HVHZ requirements — behind those numbers.
          </p>
