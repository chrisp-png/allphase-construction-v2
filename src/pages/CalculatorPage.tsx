...
export default function CalculatorPage() {
  ...
  // NOTE: FAQ schema removed from this page to avoid duplicate structured data.
  // The /frequently-asked-questions page is the primary FAQ schema source for general roofing questions.
  // Visual FAQ content below is kept for UX — only the JSON-LD schema was removed.
