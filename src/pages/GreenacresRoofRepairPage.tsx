...
export default function GreenacresRoofRepairPage() {
  ...
  const faqItems = [
    {
      question: "How do I know if my Greenacres roof needs repair or replacement?",
    ...
    {
      question: "Do roof repairs in Greenacres have to meet Florida Building Code or HVHZ rules?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Greenacres?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                <p>
                  Greenacres is an inland Palm Beach County community where roof systems experience strong seasonal storm exposure with wind-driven rain intrusion, accelerated heat and UV deterioration, and drainage challenges on low-slope sections where present. The city features a mix of single-family homes, condominiums, and HOA-governed neighborhoods with predominantly shingle and tile roofing systems, along with low-slope sections on patios and additions where applicable. All Phase Construction USA provides inspection-first roof repair in Greenacres, beginning with a <Link to="/roofing-services/roof-inspection" className="text-red-600 hover:text-red-500 underline transition-colors">diagnostic roof inspection</Link> to trace leak pathways, document moisture patterns, and determine whether targeted repairs meet Florida Building Code standards and HVHZ requirements where applicable. Learn more about <Link to="/service-areas/greenacres" className="text-red-600 hover:text-red-500 underline transition-colors">roofing services in Greenacres</Link>, or use our <Link to="/service-areas/greenacres/roof-cost-estimate" className="text-red-600 hover:text-red-500 underline transition-colors">roof cost calculator</Link> to estimate project scope. <Link to="/financing" className="text-red-600 hover:text-red-500 underline transition-colors">Flexible financing options</Link> are available.
                </p>
              </div>
        ...
        {/* Common Greenacres Repair Problems */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Greenacres
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Greenacres roof systems are exposed to seasonal storms with strong wind-driven rain, prolonged UV and heat exposure causing material deterioration, and drainage challenges on low-slope sections where present. Roof repair issues commonly include wind-driven rain intrusion at flashing and wall transitions after storm events, shingle lifting or creasing from gust forces and thermal movement, UV-driven sealant failure at pipe boots and penetrations, tile cracking or displacement where applicable, granule loss and brittle shingles from heat cycling, fascia and soffit staining from overflow at valleys or gutters, and drainage restrictions on low-slope patio or addition roofs causing ponding marks and membrane stress.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Seasonal storm patterns drive rainfall through compromised flashing seams and wall transitions, requiring targeted flashing repairs to eliminate moisture pathways and prevent interior damage.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Fascia and Soffit Staining From Overflow
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Overflow from valleys, gutters, or edge detail fatigue causes fascia and soffit moisture exposure where present, requiring flow path clearance and edge flashing verification.
                </p>
              </div>
              ...
              <div className="bg-zinc-900 border-l-4 border-red-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300 leading-relaxed">
                      Photographic documentation of conditions and preparation of measured repair scope suitable for HOA or condo association review, insurance coordination, and permit requirements where applicable.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Greenacres
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Greenacres:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, hip and ridge component restoration, and flashing upgrades for concrete and clay tile systems where present across Greenacres properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Membrane repairs, seam correction, and drainage improvements for modified bitumen, TPO, and other flat and low-slope systems on patios, additions, and covered areas. Repair techniques address both surface symptoms and underlying causal factors including drainage restrictions.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Greenacres Cause</th>
                ...
                <tbody>
                  ...
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Overflow from valleys, gutters, or edge detail fatigue</td>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Greenacres Roofing Services
                </h3>
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Greenacres properties.
                </p>
              </Link>

              <Link
                to="/service-areas/greenacres/roof-cost-estimate"
                className="block bg-zinc-800 border-2 border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-all hover:shadow-lg hover:shadow-red-600/10 group"
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Roof Cost Estimate
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Greenacres Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Detailed photo documentation and measured repair scopes suitable for HOA or condo association submissions, insurance coordination, and informed decision-making.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and flat/low-slope roof systems common to Greenacres residential and multi-family properties.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Roof Repair FAQs – Greenacres, FL
            </h2>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Greenacres.
            </p>
