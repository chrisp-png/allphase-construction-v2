...
export default function ParklandRoofRepairPage() {
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);

  useEffect(() => {
    window.scrollTo(0, 0);

    document.title = 'Roof Repair Parkland FL | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof repair services in Parkland, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof repair services in Parkland, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA coordination and insurance documentation support.';
  ...
  const faqItems = [
    {
      question: "How do I know if my Parkland roof needs repair or replacement?",
    ...
    {
      question: "Do roof repairs in Parkland have to meet Florida Building Code or HVHZ rules?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Parkland?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Roof Repair in <span className="bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">Parkland, FL</span>
              </h1>

              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                <p>
                  Parkland roofs experience intense UV exposure, thermal cycling, and strong wind loads during seasonal storms. The community's HOA-governed residential landscape includes roof systems ranging from newer installations to aging assemblies requiring targeted intervention. All Phase Construction USA provides inspection-first roof repair in Parkland, starting with a <Link to="/roofing-services/roof-inspection" className="text-red-600 hover:text-red-500 underline transition-colors">diagnostic roof inspection</Link> to identify leak sources, document moisture patterns, and determine whether targeted repairs meet Florida Building Code standards and HVHZ requirements where applicable.
                </p>
              </div>
        ...
        {/* Common Parkland Repair Problems */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Parkland
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Parkland's inland location reduces salt air exposure but concentrates heat-related deterioration and wind-driven rain intrusion patterns. Roof systems frequently exhibit wind-driven rain penetration at flashing and valley transitions, shingle lifting or fastener back-out from gust exposure, and UV-driven sealant failure around pipe boots and skylights. Tile displacement from aging fasteners, granule loss on shingles from thermal cycling, and drainage concerns on flat or low-slope sections are also routinely identified during diagnostic inspections.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Storm-driven rainfall penetrates compromised flashing seams, valleys, and wall transitions, requiring targeted flashing repairs to eliminate moisture pathways and prevent interior damage.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Gust exposure and thermal expansion cause shingle tabs to lift and fasteners to back out, compromising wind resistance and requiring code-compliant fastening corrections during repair.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    UV-Driven Sealant and Boot Failure
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Intense UV exposure deteriorates sealants around pipe boots, vents, and skylights, causing intermittent leaks that require component replacement and manufacturer-specified resealing.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Foot traffic and aging fasteners cause tiles to crack or shift, exposing underlayment to accelerated deterioration and requiring selective tile replacement with underlayment condition assessment.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                ...
                <p className="text-zinc-300">
                  Thermal cycling and sustained UV exposure cause granule loss and brittle shingle tabs that crack or lift, compromising waterproofing and requiring targeted shingle replacement to maintain system integrity.
                </p>
              </div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-colors">
                <div className="flex items-start gap-3 mb-3">
                  <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <h3 className="text-xl font-semibold text-white">
                    Drainage and Ponding on Low-Slope Sections
                  </h3>
                </div>
                <p className="text-zinc-300">
                  Low-slope roof areas and flat sections develop ponding water from drainage restrictions or slope inadequacy, accelerating membrane wear and requiring drainage correction and localized membrane reinforcement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Parkland
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Parkland:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Shingle replacement, fastener correction, and flashing repairs addressing wind uplift damage, granule loss, and localized deterioration from UV exposure. Repair approaches maintain manufacturer warranty coverage when materials are properly matched.
                </p>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, and flashing upgrades for concrete and clay tile systems prevalent across Parkland residential properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Membrane repairs, seam correction, and drainage improvements for modified bitumen, TPO, and other flat and low-slope systems on residential flat roof sections. Repair techniques address both surface symptoms and underlying causal factors.
                </p>
                <p className="text-sm text-zinc-400 italic">
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Parkland's residential communities are predominantly governed by homeowner associations with specific architectural standards and approval processes. All Phase Construction USA coordinates documentation, scope clarity, and material specifications to support HOA compliance. When repairs involve insurance claims, inspection findings and photo documentation are provided to support the claim review process without offering legal or coverage determinations.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    Parkland homeowner associations maintain architectural control standards governing material selection, color matching, and installation methodology for visible roof repairs. Repair proposals require documentation demonstrating compliance with community aesthetic requirements.
                  </p>
                  <p>
                    We provide comprehensive submission packages including material specifications, manufacturer data sheets, color samples, and installation methodology descriptions addressing common HOA review criteria. Work scheduling and access coordination is routinely handled for HOA-governed properties.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Parkland Cause</th>
                ...
                <tbody>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Ceiling staining near exterior wall or soffit</td>
                    <td className="px-6 py-4 text-zinc-300">Wind-driven rain at wall flashing or edge transitions</td>
                    <td className="px-6 py-4 text-zinc-300">Moisture migration into decking and interior cavities</td>
                    <td className="px-6 py-4 text-zinc-300">Targeted flashing repair and resealing at transitions</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Drips after heavy rain near vent pipe</td>
                    <td className="px-6 py-4 text-zinc-300">UV-cracked pipe boot collar from heat exposure</td>
                    <td className="px-6 py-4 text-zinc-300">Intermittent leaks difficult to trace and locate</td>
                    <td className="px-6 py-4 text-zinc-300">Replace boot and reseat flashing per manufacturer specs</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Lifted or missing shingle tabs at roof edges</td>
                    <td className="px-6 py-4 text-zinc-300">Thermal aging combined with gust uplift exposure</td>
                    <td className="px-6 py-4 text-zinc-300">Exposed underlayment risk and blow-off potential</td>
                    <td className="px-6 py-4 text-zinc-300">Replace damaged shingles and reinforce perimeter detailing as appropriate</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Cracked or slipped tiles over walkway areas</td>
                    <td className="px-6 py-4 text-zinc-300">Foot traffic impact or aging fasteners/underlayment</td>
                    <td className="px-6 py-4 text-zinc-300">Hidden underlayment stress and moisture intrusion</td>
                    <td className="px-6 py-4 text-zinc-300">Replace tiles and inspect localized underlayment condition</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Rusted or loose fasteners on metal components</td>
                    <td className="px-6 py-4 text-zinc-300">Washer deterioration from thermal cycling</td>
                    <td className="px-6 py-4 text-zinc-300">Fastener leaks and panel movement compromise system</td>
                    <td className="px-6 py-4 text-zinc-300">Replace fasteners with correct gasketed type and re-seat panels</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Water marks near flat roof edge or scupper</td>
                    <td className="px-6 py-4 text-zinc-300">Partial blockage or low-slope ponding areas</td>
                    <td className="px-6 py-4 text-zinc-300">Accelerated membrane wear and concealed deck stress</td>
                    <td className="px-6 py-4 text-zinc-300">Clear drainage and reinforce membrane at stress points</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 text-zinc-300">Damp ceiling line appearing after storms</td>
                    ...
                    <td className="px-6 py-4 text-zinc-300">Flashing reconstruction and sealant strategy based on condition</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                ...
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Parkland properties.
                </p>
              </Link>

              <Link
                to="/service-areas/parkland/roof-cost-estimate"
                className="block bg-zinc-800 border-2 border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-all hover:shadow-lg hover:shadow-red-600/10 group"
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Roof Cost Estimate
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Parkland Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Detailed photo documentation and measured repair scopes suitable for HOA submissions, insurance coordination, and informed decision-making.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and flat roof systems common to Parkland residential properties.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Proven experience coordinating with HOA boards, architectural review committees, and property managers to meet approval processes and scheduling requirements.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Parkland.
            </p>
