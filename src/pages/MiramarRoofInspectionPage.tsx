...
export default function MiramarRoofInspectionPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Miramar FL. Catch hidden damage before it becomes an emergency. Licensed & insured. Free inspection. Call (754) 227-5605.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Miramar FL. Catch hidden damage before it becomes an emergency. Licensed & insured. Free inspection. Call (754) 227-5605.';
  ...
  const faqs = [
    {
      question: 'How often should I get my roof inspected in Miramar?',
    ...
    },
    {
      ...
      answer: 'Inspections can identify ventilation issues and recommend roofing materials that improve energy-efficient performance, potentially lowering cooling costs in Miramar\u2019s hot climate.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-zinc-900 to-[#09090b]">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Roof Inspection Miramar FL &mdash; <span className="text-red-500">Catch Hidden Damage Before It Becomes an Emergency</span>
          </h1>
          <p className="text-xl text-zinc-300 mb-8 max-w-3xl">
            All Phase Construction USA offers complimentary, professional roof inspections for homeowners throughout Miramar, FL &mdash; tailored to the storm, heat, and high humidity conditions that affect roofs in Broward County.
          </p>
      ...
      {/* Why Miramar Needs Inspections */}
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Why Miramar, Florida Homeowners Need Regular Roof Inspections</h2>
          <p className="text-zinc-300 mb-8">
            Miramar sits in one of the most demanding climates for roofing materials in the country. Located in western Broward County with direct wind exposure off the Everglades, and home to communities surrounding Amerant Bank Arena and Sawgrass Mills Mall, Miramar properties face year-round UV exposure, daily humidity levels exceeding 70%, and frequent summer storms that create constant stress on every roofing system.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {[
              ...
              { title: 'Hurricane-Season Gusts', body: 'Even outer bands from distant storms can lift shingles and displace tiles on Miramar homes.' },
          ...
          <p className="text-zinc-300 text-sm bg-zinc-800 p-4 rounded-lg border border-zinc-700">
            Even roofs installed between 2010 and 2018 in neighborhoods like Miramar Golf Village and Inverrary can already show hidden issues like loose fasteners, cracked tiles, or dried sealant. Minor problems are often invisible from the yard but can lead to costly repairs if ignored.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-zinc-400 mb-8">
            Many Miramar homeowners call only after a roof leak appears &mdash; which is usually the most expensive time to discover a problem. Water damage that reaches ceilings and walls can cost thousands more than catching issues early.
          </p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">What All Phase Checks During a Miramar Roof Inspection</h2>
          <p className="text-zinc-300 mb-8">
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Miramar Roof Inspection Process &mdash; Step by Step</h2>
          <p className="text-zinc-400 mb-8">
            The inspection process is straightforward and usually takes 45–90 minutes for a typical single-family home in Miramar.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { step: '01', title: 'Scheduling', body: 'Call or submit an online request and choose a morning or late-afternoon slot to avoid mid-day heat. Same-week availability for most Miramar properties.' },
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Types of Roof Systems We Commonly Inspect in Miramar</h2>
          <p className="text-zinc-300 mb-8">
            Miramar neighborhoods &mdash; from Monarch Lakes and Silver Shores to Riviera Isles and Sunset Lakes &mdash; include a mix of roofing systems. All Phase tailors each inspection checklist based on the exact system and year of last replacement.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { title: 'Concrete or Clay Tile Roofs', body: 'Found in many Miramar subdivisions. Watch for cracked tiles, slipped tiles, and underlayment aging around the 15\u201320 year mark.' },
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Miramar Storm Season &amp; Post-Storm Evaluations</h2>
          <p className="text-zinc-300 mb-6">
            Atlantic hurricane season runs June 1 through November 30, with late-summer storms posing the greatest threat to Miramar properties. Even when a named storm does not make a direct hit, outer bands and strong thunderstorms can still damage roofs through high winds and flying debris.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Estimated Service Life', body: 'Range of remaining years based on material condition and local Miramar climate factors.' },
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Frequently Asked Questions About Miramar Roof Inspections</h2>
      ...
      <section className="py-16 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-white">Schedule Your Complimentary Miramar Roof Inspection Today</h2>
          <p className="text-zinc-300 mb-4 max-w-3xl mx-auto">
            Do not wait for leaks, water damage, or insurance complications to learn what condition your roof is in. A complimentary inspection from All Phase Construction USA gives Miramar homeowners the peace of mind that comes from knowing exactly where they stand.
          </p>
          <p className="text-zinc-400 mb-8 max-w-3xl mx-auto text-sm">
            We serve all Miramar neighborhoods including Monarch Lakes, Silver Shores, Riviera Isles, Sunset Lakes, Country Lakes, Miramar Town Center, and communities throughout western Broward County.
          </p>
