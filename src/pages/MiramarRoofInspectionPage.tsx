...
export default function MiramarRoofInspectionPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Roof Inspection Miramar FL | All Phase Construction USA';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof inspection in Miramar FL. Know if you need repair or replacement before spending thousands. Licensed & insured. Free inspection. Call (754) 227-5605.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof inspection in Miramar FL. Know if you need repair or replacement before spending thousands. Licensed & insured. Free inspection. Call (754) 227-5605.';
  ...
  const faqs = [
    {
      question: 'How long does a roof inspection take in Miramar?',
      answer: 'Most inspections take 45 minutes to 2 hours, depending on roof size and complexity. We’re thorough because missing hidden issues defeats the purpose of the inspection.',
    },
    {
      question: 'What specific issues should Miramar homeowners watch for due to local climate?',
      answer: 'Our humid subtropical climate accelerates mold growth, algae buildup, and granule loss on old shingles. High winds cause missing shingles and flashing damage. Intense sun degrades roofing materials faster than in northern climates. Regular inspections catch these problems early.',
    },
    {
      question: 'Can an inspection really help me avoid unnecessary roof replacement?',
      answer: 'Absolutely. Many roofs we inspect need restoration — addressing cracked tiles, damaged shingles, or drainage issues — rather than complete replacement. Only a proper inspection reveals whether your roof structure remains sound beneath surface wear.',
    },
    {
      question: 'Do I need to be home during the inspection process?',
      answer: 'We prefer you’re available to discuss findings immediately, but we can work with your schedule. We’ll provide clear communication either way.',
    },
    {
      question: 'How soon after a storm should I schedule an inspection?',
      answer: 'As soon as safely possible. Storm damage often isn’t visible from the ground, and insurance claims have time limits. Early leak detection prevents water damage from compounding.',
    },
    {
      question: 'Will the inspection damage my roof or landscaping?',
      answer: 'Never. Our drone technology eliminates the need to walk on many roofs, and when roof access is required, our inspectors take proactive steps to protect your property.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <div className="bg-[#09090b] border-b border-zinc-800 py-3">
        <div className="max-w-6xl mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm text-zinc-400">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Miramar</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-zinc-900 to-[#09090b]">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Roof Inspection Miramar FL — <span className="text-red-500">Know Before You Repair or Replace</span>
          </h1>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Why Choose Professional Roof Inspections in Miramar?</h2>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-white">Common Roof Problems in Miramar Homes</h2>
          <p className="text-zinc-400 mb-8">Miramar homes face unique roofing challenges due to the subtropical climate &mdash; high winds, heavy rainfall, and intense sunlight. Here are the most common issues we find:</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: 'The combination of humidity and frequent rain creates ideal conditions for mold and algae to thrive on Miramar roofs. These growths weaken roofing materials and lead to further damage if left untreated.',
              },
              {
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">What Makes Our Miramar Roof Inspections Different?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
              ...
              },
              {
                ...
                body: 'Extensive experience identifying wind, hail, and water leak damage specific to South Florida storms, including subtle red flags that untrained eyes miss. We know what Miramar’s weather does to roofs.',
              },
              {
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto">
          ...
          <h3 className="text-xl font-semibold text-red-500 mb-4">Free Initial Roof Inspection for Miramar Homeowners</h3>
          <p className="text-zinc-300 mb-6">
            We believe every homeowner deserves to know their roof\'s condition without financial barriers. That\'s why we offer a free roof inspection to residents throughout Miramar and surrounding Broward County communities.
          </p>
          <p className="text-zinc-300 mb-8">
            Consider the math: The average roof replacement costs $8,000 to $20,000 for typical Miramar homes. Meanwhile, targeted roof repairs often range from $500 to $5,000 depending on the issue. A thorough inspection ensures you\'re investing in the right solution.
          </p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">Frequently Asked Questions About Roof Inspections in Miramar</h2>
      ...
      <section className="py-16 px-4 bg-zinc-900">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-white">Schedule Your Free Miramar Roof Inspection Today</h2>
          ...
          <p className="text-zinc-400 mb-8 max-w-3xl mx-auto text-sm">
            We serve all Miramar neighborhoods including Sunset Lakes, Silver Lakes, Silver Shores, Riviera Isles, Nautica, and properties along the Pembroke Road corridor near the Broward/Miami-Dade county line.
          </p>
          ...
          <p className="text-zinc-500 text-sm">
            Dual Licensed: CGC-1526236 &amp; CCC-1331464 &nbsp;&nbsp;|&nbsp;&nbsp; Fully Insured &nbsp;&nbsp;|&nbsp;&nbsp; Serving Miramar, FL and Broward County
          </p>
        </div>
      </section>
