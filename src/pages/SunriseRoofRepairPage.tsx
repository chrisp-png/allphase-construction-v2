...
export default function SunriseRoofRepairPage() {
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);

  useEffect(() => {
    window.scrollTo(0, 0);

    document.title = 'Roof Repair Sunrise FL | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof repair services in Sunrise, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA/condo coordination and insurance documentation support.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof repair services in Sunrise, FL. Diagnostic inspections, code-compliant repairs for tile, shingle, flat, and metal roofs. HOA/condo coordination and insurance documentation support.';
  ...
  const faqItems = [
    {
      question: "How do I know if my Sunrise roof needs repair or replacement?",
    ...
    {
      question: "Do roof repairs in Sunrise have to meet Florida Building Code or HVHZ rules?",
    ...
    {
      question: "How do you handle HOA approvals for roof repairs in Sunrise?",
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Roof Repair in <span className="bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">Sunrise, FL</span>
              </h1>

              <div className="text-lg md:text-xl text-zinc-300 mb-10 leading-relaxed space-y-4">
                <p>
                  Sunrise's inland Broward location experiences strong seasonal storm exposure, intense wind-driven rain, and sustained heat and UV cycling that stress roof systems across mixed housing ages and architectural styles. The city features diverse residential roof assemblies including asphalt shingle, tile, metal, and low-slope sections on additions and flat roof areas, with HOA and condo management oversight present throughout portions of the market. All Phase Construction USA provides inspection-first roof repair in Sunrise, beginning with a <Link to="/roofing-services/roof-inspection" className="text-red-600 hover:text-red-500 underline transition-colors">diagnostic roof inspection</Link> to trace leak pathways, document moisture patterns, and determine whether targeted repairs meet Florida Building Code standards and HVHZ requirements where applicable.
                </p>
              </div>
        ...
        {/* Common Sunrise Repair Problems */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Common Roof Repair Issues in Sunrise
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              Sunrise roof systems are exposed to intense seasonal storm activity, wind-driven rain, and accelerated heat and UV deterioration characteristic of inland Broward settings. Roof repair issues commonly include wind-driven rain penetration at flashing and valley transitions after seasonal storms, shingle lifting or fastener back-out from gust exposure and thermal movement, UV-driven sealant failure at pipe boots and penetrations, granule loss and brittle shingles from prolonged heat cycling, tile cracking or displacement where applicable, roof-to-wall leaks at stucco transitions on mixed rooflines, and drainage restrictions on low-slope roofs leading to ponding and membrane stress.
            </p>
        ...
        <section className="py-20 bg-zinc-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Roof Systems Repaired in Sunrise
            </h2>
            <p className="text-lg text-zinc-300 mb-10 leading-relaxed">
              All Phase Construction USA performs code-compliant repairs on the following roof systems commonly found in Sunrise:
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6">
                ...
                <p className="text-zinc-300 mb-3">
                  Individual tile replacement, underlayment section repair, hip and ridge component restoration, and flashing upgrades for concrete and clay tile systems where present across Sunrise properties. Repair feasibility depends on tile availability and underlayment condition assessment.
                </p>
                <p className="text-sm text-zinc-400 italic">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <table className="w-full bg-zinc-800 border border-zinc-700 rounded-lg">
                <thead>
                  <tr className="bg-zinc-900 border-b border-zinc-700">
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Common Sunrise Cause</th>
                ...
                <tbody>
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Ceiling staining after afternoon downpours</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    <td className="px-6 py-4 text-zinc-300">Lifted shingles along edges or corners</td>
                  ...
                  <tr className="border-b border-zinc-700">
                    ...
                    <td className="px-6 py-4 text-zinc-300">Faster leak risk at cracks and edges</td>
                    <td className="px-6 py-4 text-zinc-300">Replace damaged shingles and evaluate surrounding field condition</td>
                  </tr>
                  <tr className="border-b border-zinc-700">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              ...
              >
                ...
                <p className="text-zinc-300">
                  Comprehensive roofing services including repair and replacement for Sunrise properties.
                </p>
              </Link>

              <Link
                to="/service-areas/sunrise/roof-cost-estimate"
                className="block bg-zinc-800 border-2 border-zinc-700 rounded-lg p-6 hover:border-red-600 transition-all hover:shadow-lg hover:shadow-red-600/10 group"
              >
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-600 transition-colors">
                  Roof Cost Estimate
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Sunrise Property Owners Choose All Phase Construction USA
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Technical competence with shingle, tile, metal, and flat/low-slope roof systems common to Sunrise residential and multi-family properties.</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-zinc-950 via-black to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Active leaks, visible damage, or suspected roof deterioration require prompt diagnostic assessment. Contact All Phase Construction USA for comprehensive roof inspection and code-compliant repair scoping in Sunrise.
            </p>
