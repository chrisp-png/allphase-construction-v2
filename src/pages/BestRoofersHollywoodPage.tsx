          ...
          {JSON.stringify([
            {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Hollywood",
                  "item": "https://allphaseconstructionfl.com/locations/hollywood"
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": "Best Roofers in Hollywood",
                  "item": "https://allphaseconstructionfl.com/locations/hollywood/best-roofers-hollywood"
                }
              ]
            },
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "How much does a new roof cost in Hollywood, FL?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Most residential roof replacements in Hollywood range from $9,000 to $45,000+ depending on roof type, size, and materials. HVHZ compliance and Broward County permitting add cost that is unavoidable and non-negotiable for code-compliant work."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Do I need a permit for roofing work in Hollywood / Broward County?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                ...
                {
                  "@type": "Question",
                  "name": "What is HVHZ and does it apply to Hollywood?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "HVHZ stands for High Velocity Hurricane Zone. Hollywood is in Broward County, which is entirely designated HVHZ. Every roofing material and installation method must meet Florida Building Code Section 1504 wind resistance requirements and carry a Notice of Acceptance (NOA)."
                  }
                },
                {
                  "@type": "Question",
                ...
                {
                  "@type": "Question",
                  "name": "Can a Hollywood homeowner pull their own roof permit?",
                  "acceptedAnswer": {
                    "@type": "Answer",
            ...
            },
            {
              ...
              "description": "Dual-licensed roofing and general contractor serving Hollywood and Broward County since 2005. Specializing in HVHZ-compliant roof systems, wind mitigation upgrades, and insurance premium reduction for coastal and canal-front properties.",
              "areaServed": ["Hollywood", "Broward County", "Palm Beach County"]
            }
          ])}
        </script>
      </Helmet>
