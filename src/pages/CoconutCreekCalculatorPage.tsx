...
export default function CoconutCreekCalculatorPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  useEffect(() => {
    document.title = 'Coconut Creek Roof Cost Calculator | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Use this roof cost calculator to get a fast ballpark estimate for Coconut Creek roofing projects. Final pricing depends on inspection, roof complexity, and material selection.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Use this roof cost calculator to get a fast ballpark estimate for Coconut Creek roofing projects. Final pricing depends on inspection, roof complexity, and material selection.';
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is this pricing final?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. It is a preliminary estimate pending inspection."
          }
        },
        {
          "@type": "Question",
          "name": "What affects roof cost in Coconut Creek?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Roof size, roof system, complexity, and deck condition."
          }
        },
        {
          "@type": "Question",
  ...
  const faqs = [
    {
      ...
      answer: "No. It is a preliminary estimate pending inspection."
    },
    {
      question: 'What affects roof cost in Coconut Creek?',
      answer: "Roof size, roof system, complexity, and deck condition."
    },
    {
      ...
      <div className="pt-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <nav className="flex items-center space-x-2 text-sm mb-8">
            ...
            <span className="text-zinc-600">/</span>
            <Link to="/locations/deerfield-beach/service-area/coconut-creek/" className="text-zinc-400 hover:text-red-600 transition-colors">
              Coconut Creek
            </Link>
            <span className="text-zinc-600">/</span>
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-6 leading-relaxed">
              Use this roof cost calculator to get a fast ballpark estimate based on roof size and roof type. Final pricing depends on inspection results and roof conditions.
            </p>
          </div>
          ...
          <div className="mb-20 mt-20">
            ...
            <p className="text-zinc-400 text-center max-w-3xl mx-auto mb-8 leading-relaxed">
              Estimate monthly payments for your Coconut Creek roof using the financing calculator below.
            </p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-center">
              How much does a roof cost in Coconut Creek?
            </h2>
          ...
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
              Frequently Asked Questions – Coconut Creek Roof Cost Calculator
            </h2>
