...
export default function WiltonManorsMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Wilton Manors', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '150' } });
  const faqs = [
