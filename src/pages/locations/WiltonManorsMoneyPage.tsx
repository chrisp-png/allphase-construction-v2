...
export default function WiltonManorsMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Wilton Manors', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
