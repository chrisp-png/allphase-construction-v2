...
export default function NorthPalmBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'North Palm Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
