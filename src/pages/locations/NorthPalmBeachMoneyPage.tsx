...
export default function NorthPalmBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'North Palm Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '150' } });
  const faqs = [
