...
export default function WestlakeMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Westlake', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
