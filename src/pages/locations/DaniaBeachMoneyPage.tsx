...
export default function DaniaBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Dania Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
