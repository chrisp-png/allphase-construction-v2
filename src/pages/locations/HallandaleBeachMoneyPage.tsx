...
export default function HallandaleBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Hallandale Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
