...
export default function HighlandBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Highland Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
