...
export default function LantanaMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Lantana', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
