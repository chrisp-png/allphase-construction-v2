...
export default function MiramarMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Miramar', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
