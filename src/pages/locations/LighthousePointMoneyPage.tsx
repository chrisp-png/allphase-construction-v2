/**
 * ═══════════════════════════════════════════════════════════════════════════
 * Lighthouse Point Custom Location Page (PR-88)
 * ═══════════════════════════════════════════════════════════════════════════
 * Fully tailored to Lighthouse Point, FL — Broward County, HVHZ.
 * Lighthouse Point is a 2.4 sq-mi waterfront city with concentrated
 * affluence (median household income above $130K). Roofing market skews
 * to Spanish tile and standing-seam metal on waterfront mansions, with
 * direct ocean wind exposure making HVHZ compliance non-negotiable.
 * Content tuned to those specifics for AI snippet eligibility and to
 * break the thin-content pattern caught by Google's crawled-not-indexed
 * filter.
 */
...
export default function LighthousePointMoneyPage() {
  const cityName = 'Lighthouse Point';
  const county = 'Broward County';
  const slug = 'lighthouse-point';

  useEffect(() => {
    const seoMeta = generateSEOMetadata('/locations/lighthouse-point');
  ...
  return (
    <>
      <Helmet>
        <title>Roof Replacement Lighthouse Point, FL | All Phase USA</title>
        <meta name="description" content="Lighthouse Point roof replacement by a dual-licensed, HVHZ-certified contractor. Spanish tile and standing-seam metal specialists for waterfront 33064 homes off Cap\u2019s Place and the Hillsboro Inlet. Free inspection. (754) 227-5605." />
      ...
      <div className="min-h-screen bg-black text-white">
            ...
            <div className="max-w-4xl">
              ...
              <div className="prose prose-invert max-w-none mb-8">
                <p className="text-xl text-zinc-300 leading-relaxed mb-6">
                  All Phase Construction USA is a top-rated roofing contractor serving {cityName}, FL — a 2.4-square-mile waterfront city of roughly 10,500 residents bounded by the Hillsboro Inlet to the north, the Intracoastal Waterway to the east, Pompano Beach to the south, and Federal Highway to the west, contained entirely within ZIP code 33064. We're dual-licensed as both a Florida State Certified Roofing Contractor (CCC-1331464) and a Certified General Contractor (CGC-1526236), and our crews work in Lighthouse Point regularly — with the bulk of our work being Spanish tile re-roofs, standing-seam metal installations, and high-end repair work on waterfront homes along the city's intricate network of finger canals.
                </p>
                <p className="text-xl text-zinc-300 leading-relaxed">
                  Lighthouse Point sits inside Florida's High Velocity Hurricane Zone (HVHZ) and takes the direct brunt of Atlantic wind events with no inland buffer — every roof we install here is engineered to the HVHZ standard with 175+ mph wind ratings, sealed roof decks, enhanced fastening schedules, and Miami-Dade NOA-approved materials, plus the tile underlayment systems and ridge attachment details that hold up in concentrated salt air. Based 3 miles north in Deerfield Beach, we know the Lighthouse Point Building Department workflow on NE 24th Court, the high finish-quality expectations of waterfront homeowners, and exactly how to coordinate a tear-off and re-roof around boat lifts, docks, and the tight setbacks of a 5,000-square-foot home on a 70-foot canal-front lot. Call (754) 227-5605 for a free roof inspection in {cityName}.
                </p>
              </div>
        ...
        <CityProjectGallery slug="lighthouse-point" />
        <MoneyPageStatBar />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-zinc-300 leading-relaxed">
                  <p>
                    Most roofing contractors in Lighthouse Point hold only a Certified Roofing Contractor (CCC) license. All Phase Construction USA holds both CCC-1331464 and CGC-1526236, which means on a waterfront tile tear-off we can rebuild the chimney crown, re-fit a fireplace cap, replace rotted parapet decking, and re-flash a skylight or chase — all within the same project and the same permit — rather than calling in a structural sub mid-job.
                  </p>
                  <p>
                    That matters in Lighthouse Point because the housing stock is dominated by 1960s and 1970s waterfront construction with reinforced masonry walls, concrete tile roofs, exposed wood ceiling planks, and second-story owner's suites that complicate any structural intervention. When we pull a 35-year-old concrete tile roof off a home on NE 27th Avenue or Cap's Drive and find compromised decking around a roof penetration or rotted ridge framing under a hip cap, we have the legal authority to fix it the same day rather than handing your project off to a structural sub.
                  </p>
                  <p>
        ...
        {/* Why Lighthouse Point Homeowners Hire All Phase */}
        <section className="py-20 bg-zinc-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-zinc-400 max-w-3xl mx-auto">
                Serving Lighthouse Point from our Deerfield Beach headquarters — just 3 miles north — with intimate knowledge of Broward building codes, the city permit workflow at the Lighthouse Point Building Department on NE 24th Court, and the regional roofing challenges unique to direct-Atlantic-exposure waterfront homes.
              </p>
            </div>
        ...
        {/* Lighthouse Point Neighborhoods We Serve */}
        <section className="py-20 bg-zinc-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#C5A572]/10 text-[#C5A572] px-4 py-2 rounded-lg text-sm font-semibold mb-6 border border-[#C5A572]/20">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-zinc-300 leading-relaxed">
              ...
              <p>
                Whether you own a waterfront home off NE 27th Avenue, a canal-front property in the Cap's Place area, or a townhouse along Federal Highway, we bring the same dual-license authority and HVHZ-grade installation standards to every Lighthouse Point address.
              </p>
            </div>
          </div>
        </section>
