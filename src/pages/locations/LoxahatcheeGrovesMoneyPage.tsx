...
export default function LoxahatcheeGrovesMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Loxahatchee Groves', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
