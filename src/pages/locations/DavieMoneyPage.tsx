...
export default function DavieMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Davie', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
