...
export default function LauderhillMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Lauderhill', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
