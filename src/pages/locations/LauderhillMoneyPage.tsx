...
export default function LauderhillMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Lauderhill', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '150' } });
  const faqs = [
