...
export default function MargateMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Margate', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Margate, FL roofer for canal homes, gated & 55+ communities — HVHZ-code shingle, tile & metal, HOA review handled, dual-licensed since 2006. (754) 227-5605." />
