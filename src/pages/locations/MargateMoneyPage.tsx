...
export default function MargateMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Margate', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '153' } });
  const faqs = [
