...
export default function PalmBeachGardensMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Palm Beach Gardens', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
