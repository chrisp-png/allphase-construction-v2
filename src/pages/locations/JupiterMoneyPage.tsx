...
export default function JupiterMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Jupiter', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
