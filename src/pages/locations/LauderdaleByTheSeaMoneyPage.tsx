...
export default function LauderdaleByTheSeaMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Lauderdale-by-the-Sea', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
