...
export default function HollywoodMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Hollywood', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
