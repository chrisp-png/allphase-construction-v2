...
export default function HaverhillMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Haverhill', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '153' } });
  const faqs = [
