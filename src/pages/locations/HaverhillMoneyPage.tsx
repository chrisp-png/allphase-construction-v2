...
export default function HaverhillMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Haverhill', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
