...
export default function HypoluxoMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Hypoluxo', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '153' } });
  const faqs = [
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="py-16 bg-zinc-950 border-t border-zinc-900">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Roofing Near Hypoluxo</h2>
            <p className="text-zinc-400 mb-8 max-w-2xl mx-auto">All Phase Construction USA also serves the communities around Hypoluxo across Palm Beach County:</p>
