...
export default function HypoluxoMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Hypoluxo', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
