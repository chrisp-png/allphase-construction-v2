...
export default function LauderdaleLakesMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Lauderdale Lakes', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '153' } });
  const faqs = [
