...
export default function HillsboroBeachMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Hillsboro Beach', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
