...
export default function PalmBeachCountyHubPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Palm Beach County', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
