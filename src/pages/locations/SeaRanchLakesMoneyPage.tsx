...
export default function SeaRanchLakesMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Sea Ranch Lakes', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
