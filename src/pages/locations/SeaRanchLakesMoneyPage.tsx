...
export default function SeaRanchLakesMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Sea Ranch Lakes', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.8', reviewCount: '150' } });
  const faqs = [
