...
export default function ParklandMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Parkland', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
