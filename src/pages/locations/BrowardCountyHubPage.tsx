...
export default function BrowardCountyHubPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Broward County', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
