...
export default function CooperCityMoneyPage() {
  ...
  const businessSchema = generateLocalBusinessSchema({ cityName: 'Cooper City', stateName: 'Florida', latitude: coordinates?.latitude, longitude: coordinates?.longitude, aggregateRating: { ratingValue: '4.9', reviewCount: '160' } });
  const faqs = [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Cooper City, FL roofer for family suburbs & gated communities — HVHZ-code tile & shingle, HOA review handled, dual-licensed. (754) 227-5605." />
