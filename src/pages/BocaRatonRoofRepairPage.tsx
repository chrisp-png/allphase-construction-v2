...
export default function BocaRatonRoofRepairPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'Roof Repair Boca Raton FL | All Phase';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional roof repair services in Boca Raton, FL. Inspection-first approach for tile, flat, metal, and shingle roof repairs. Diagnostic inspections, HOA coordination, insurance documentation.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional roof repair services in Boca Raton, FL. Inspection-first approach for tile, flat, metal, and shingle roof repairs. Diagnostic inspections, HOA coordination, insurance documentation.';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Roof Repair in <span className="bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">Boca Raton, FL</span>
              </h1>
