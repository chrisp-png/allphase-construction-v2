...
// PR-53 reverted: HomePage stays lazy. The eager-load attempt cut mobile
// LCP only 0.4s but ballooned the main bundle and tanked desktop TBT
// from 30ms to 550ms (desktop perf 99 -> 76). Net negative — keeping
...
const GreenacresMoneyPage = lazy(() => import('./pages/locations/GreenacresMoneyPage'));
const JupiterMoneyPage = lazy(() => import('./pages/locations/JupiterMoneyPage'));
const MiramarMoneyPage = lazy(() => import('./pages/locations/MiramarMoneyPage'));
const MargateMoneyPage = lazy(() => import('./pages/locations/MargateMoneyPage'));
const LauderhillMoneyPage = lazy(() => import('./pages/locations/LauderhillMoneyPage'));
...
const SeaRanchLakesMoneyPage = lazy(() => import('./pages/locations/SeaRanchLakesMoneyPage'));
const HillsboroBeachMoneyPage = lazy(() => import('./pages/locations/HillsboroBeachMoneyPage'));
const NorthPalmBeachMoneyPage = lazy(() => import('./pages/locations/NorthPalmBeachMoneyPage'));
const LantanaMoneyPage = lazy(() => import('./pages/locations/LantanaMoneyPage'));
const RoyalPalmBeachMoneyPage = lazy(() => import('./pages/locations/RoyalPalmBeachMoneyPage'));
const LoxahatcheeGrovesMoneyPage = lazy(() => import('./pages/locations/LoxahatcheeGrovesMoneyPage'));
const PompanoBeachMoneyPage = lazy(() => import('./pages/locations/PompanoBeachMoneyPage'));
const ParklandMoneyPage = lazy(() => import('./pages/locations/ParklandMoneyPage'));
const WiltonManorsMoneyPage = lazy(() => import('./pages/locations/WiltonManorsMoneyPage'));
const DavieMoneyPage = lazy(() => import('./pages/locations/DavieMoneyPage'));
const HollywoodMoneyPage = lazy(() => import('./pages/locations/HollywoodMoneyPage'));
const PalmBeachGardensMoneyPage = lazy(() => import('./pages/locations/PalmBeachGardensMoneyPage'));
const PembrokePinesMoneyPage = lazy(() => import('./pages/locations/PembrokePinesMoneyPage'));
...
const BrowardCountyHubPage = lazy(() => import('./pages/locations/BrowardCountyHubPage'));
const PalmBeachCountyHubPage = lazy(() => import('./pages/locations/PalmBeachCountyHubPage'));
      ...
      <main className="flex-grow">
        <Suspense fallback={<PageLoadingFallback />}>
          <Routes>
            ...
            <Route path="/locations/greenacres" element={<GreenacresMoneyPage />} />
            <Route path="/locations/jupiter" element={<JupiterMoneyPage />} />
            <Route path="/locations/miramar" element={<MiramarMoneyPage />} />
            <Route path="/locations/margate" element={<MargateMoneyPage />} />
            <Route path="/locations/lauderhill" element={<LauderhillMoneyPage />} />
            ...
            <Route path="/locations/sea-ranch-lakes" element={<SeaRanchLakesMoneyPage />} />
            <Route path="/locations/hillsboro-beach" element={<HillsboroBeachMoneyPage />} />
            <Route path="/locations/north-palm-beach" element={<NorthPalmBeachMoneyPage />} />
            <Route path="/locations/lantana" element={<LantanaMoneyPage />} />
            <Route path="/locations/royal-palm-beach" element={<RoyalPalmBeachMoneyPage />} />
            <Route path="/locations/loxahatchee-groves" element={<LoxahatcheeGrovesMoneyPage />} />
            <Route path="/locations/pompano-beach" element={<PompanoBeachMoneyPage />} />
            <Route path="/locations/parkland" element={<ParklandMoneyPage />} />
            <Route path="/locations/wilton-manors" element={<WiltonManorsMoneyPage />} />
            <Route path="/locations/davie" element={<DavieMoneyPage />} />
            <Route path="/locations/hollywood" element={<HollywoodMoneyPage />} />
            <Route path="/locations/palm-beach-gardens" element={<PalmBeachGardensMoneyPage />} />
            <Route path="/locations/pembroke-pines" element={<PembrokePinesMoneyPage />} />
            ...
            <Route path="/locations/broward-county" element={<BrowardCountyHubPage />} />
            <Route path="/locations/palm-beach-county" element={<PalmBeachCountyHubPage />} />
