 ...
 *
 * QUOTING CONVENTION: All strings in this file use DOUBLE quotes so that
 * scripts/prerender-static.mjs can parse the array via its existing
 * TypeScript-to-JSON conversion. Apostrophes inside strings MUST use the
 * unicode right single quotation mark (U+2019, "'") — never the ASCII
 * apostrophe — or JSON.parse will fail at build time.
 */
...
export const landmarks: Landmark[] = [
  // ─── BOCA RATON ──────────────────────────────────────────────────────────
  {
    ...
    citySlug: "boca-raton",
    name: "Mizner Park",
    shortDescriptor: "the heart of downtown Boca Raton, where mixed-use residential above ground-floor retail creates one of Palm Beach County's most architecturally distinctive roofing environments.",
    localContext: "Mizner Park sits at the center of downtown Boca Raton along Federal Highway between Palmetto Park Road and Glades Road. The complex blends condominium towers, upscale retail, the Mizner Park Amphitheater, and the Boca Raton Museum of Art. Surrounding single-family neighborhoods — Old Floresta, Spanish Village, and Royal Palm Yacht and Country Club — contain some of the oldest and most prestigious tile roofs in Palm Beach County, many dating to the original Addison Mizner Mediterranean Revival period.",
...

  {
    ...
    shortDescriptor: "the retail and residential anchor of west Boca Raton, where 1970s through 1990s single-family communities share the neighborhood with one of Palm Beach County's largest shopping destinations.",
    localContext: "Town Center at Boca Raton sits at the Glades Road and Military Trail interchange, anchoring a residential corridor that stretches from Yamato Road south to Palmetto Park Road. The communities surrounding Town Center — Boca Del Mar, Boca Pointe, Boca West, Del Mar Village, and the gated sections north of Yamato — were built largely between 1975 and 1995 and contain thousands of concrete tile and architectural shingle roofs now reaching or past their 25-year service interval.",
...

  {
    ...
    shortDescriptor: "the 850-acre main campus in central Boca Raton, anchoring a residential corridor of 1960s through 1980s single-family homes, graduate housing, and rental properties with distinct roofing challenges.",
    localContext: "Florida Atlantic University's main campus occupies a large footprint north of Glades Road between NW 10th Avenue and Military Trail. The surrounding residential neighborhoods — University Park, Boca Square, Palms at Boca Pointe, and the corridor along NW 2nd Avenue — include a mix of owner-occupied single-family homes, faculty housing, and investor-owned rental properties. Many of these homes were built during FAU's 1960s through 1980s expansion and have original or single-generation-replaced roofing systems.",
