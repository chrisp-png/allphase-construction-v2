...
export const locations: Location[] = [
  // ─── HQ ───
  {
    ...
    descriptionOverride: "Deerfield Beach local roofing HQ since 2006. 2,500+ roofs, dual-licensed (CCC + CGC), 160+ five-star Google reviews. Free inspection (754) 227-5605.",
