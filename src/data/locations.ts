...
export const locations: Location[] = [
  // ─── HQ ───
  {
    ...
    county: "Broward",
    hvhz: true,
    titleOverride: "Deerfield Beach Roofing Contractor (HQ Since 2005)",
    descriptionOverride: "Deerfield Beach local roofing HQ since 2006. 2,500+ roofs, dual-licensed (CCC + CGC), 150+ five-star Google reviews. Free inspection (754) 227-5605.",
    ...
    localHook: "Headquartered in Deerfield Beach since 2006 — every truck rolls from 590 Goolsby Blvd."
  },
  ...
  // ─── Wave A ───
  {
    ...
    descriptionOverride: "Boca Raton roof replacement. Dual-licensed, voluntarily built to Miami-Dade HVHZ spec. Insurance savings built in. Free inspection (754) 227-5605.",
  ...
  },
  {
    ...
    descriptionOverride: "Delray Beach roof replacement. Dual-licensed, voluntarily built to Miami-Dade HVHZ spec for maximum insurance savings. Free inspection (754) 227-5605.",
  ...
  },
  {
    ...
    county: "Broward",
    hvhz: true,
    titleOverride: "Parkland Roof Replacement | Tile & Slate | All Phase",
  ...
  },
  {
    ...
    county: "Broward",
    hvhz: true,
    titleOverride: "Davie Roof Replacement | Ranch & Estate | All Phase",
  ...
  },
  {
    ...
    county: "Broward",
    hvhz: true,
    titleOverride: "Hollywood FL Coastal Roof Replacement | All Phase",
  ...
  },
  {
    ...
    county: "Palm Beach",
    hvhz: false,
    titleOverride: "Palm Beach Gardens Roof Replacement | Tile | All Phase",
  ...
  },
  {
    ...
    county: "Palm Beach",
    hvhz: false,
    titleOverride: "Jupiter FL Coastal Roof Replacement | Tile | All Phase",
  ...
  { slug:"pembroke-park", city:"Pembroke Park", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Roof Replacement Pembroke Park, FL | All Phase USA",
    descriptionOverride:"Pembroke Park roof replacement. HVHZ-certified, dual-licensed Broward contractor. Shingle, tile & metal. Free inspection (754) 227-5605.",
    zips:["33009","33023"],
    landmarks:["Pembroke Park Town Hall","Pembroke Park Community Park"],
    localHook:"HVHZ-certified Pembroke Park reroofs." },
  { slug:"sea-ranch-lakes", city:"Sea Ranch Lakes", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Sea Ranch Lakes FL Coastal Roof Replacement | All Phase",
    descriptionOverride:"Sea Ranch Lakes coastal roof replacement. Marine-grade, HVHZ-certified installation. Dual-licensed. Free inspection (754) 227-5605.",
    zips:["33308"],
    landmarks:["Sea Ranch Club","Sea Ranch Lakes Beach"],
    localHook:"Coastal HVHZ specialist for barrier-island village roofs." },
  { slug:"southwest-ranches", city:"Southwest Ranches", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Southwest Ranches FL Estate Roof Replacement | All Phase",
    descriptionOverride:"Southwest Ranches estate roof replacement. Tile, metal & large-acreage homes. HVHZ-certified, dual-licensed. Free inspection (754) 227-5605.",
    neighborhoods:["Sunshine Ranches","Rolling Oaks","Green Meadows","Country Estates"],
    zips:["33330","33331","33332"],
    landmarks:["Southwest Ranches Town Hall","Frank Veltri Tennis Center"],
    localHook:"HVHZ-certified estate roofing for large-acreage Southwest Ranches homes." },
  { slug:"lauderdale-lakes", city:"Lauderdale Lakes", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Roof Replacement Lauderdale Lakes, FL | All Phase USA",
    descriptionOverride:"Lauderdale Lakes roof replacement. Shingle, tile & metal. HVHZ-certified, dual-licensed. Free inspection (754) 227-5605.",
    neighborhoods:["Eastgate","Westgate","Somerset","Oriole Estates"],
    zips:["33309","33311","33313","33319"],
    landmarks:["Lauderdale Lakes City Hall","Vincent Torres Memorial Park","Willie L. Webb Sr. Park"],
    localHook:"HVHZ-certified Lauderdale Lakes reroofs." },
  ...
  { slug:"oakland-park", city:"Oakland Park", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Oakland Park Roofing Contractor (Flat Roof Specialists)",
    descriptionOverride:"Oakland Park roof replacement by a dual-licensed HVHZ-certified contractor. Flat-roof specialists for mid-century homes plus shingle tile metal. Free inspection (754) 227-5605.",
  ...
  { slug:"wilton-manors", city:"Wilton Manors", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Wilton Manors Mid-Century Roof Replacement | All Phase",
  ...
  { slug:"lighthouse-point", city:"Lighthouse Point", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Lighthouse Point Roofing Contractor (Spanish Tile and Metal)",
    descriptionOverride:"Lighthouse Point roof replacement by a dual-licensed HVHZ-certified contractor. Spanish tile and standing-seam metal for waterfront homes. Free inspection (754) 227-5605.",
    neighborhoods:["Cap's Place area","Coral Key","South Lighthouse Point","North Lighthouse Point"],
    zips:["33064"],
    landmarks:["Hillsboro Inlet Lighthouse","Cap's Place island restaurant","Hillsboro Mile waterfront"],
    localHook:"Lighthouse Point takes direct Atlantic wind exposure with no inland buffer. Every tile and metal install here is engineered to HVHZ spec with reinforced ridge and hip attachment for salt-air longevity." },
  ...
  { slug:"hallandale-beach", city:"Hallandale Beach", state:"FL", county:"Broward", hvhz:true,
    titleOverride:"Hallandale Beach Condo & Flat Roofing | All Phase",
  ...
  { slug:"westlake", city:"Westlake", state:"FL", county:"Palm Beach", hvhz:false,
    titleOverride:"Westlake FL New-Build Roof Replacement | All Phase",
  ...
  { slug:"lake-worth-beach", city:"Lake Worth Beach", state:"FL", county:"Palm Beach", hvhz:false,
    titleOverride:"Lake Worth Beach Roofer — 2,500+ Roofs | All Phase USA",
    descriptionOverride:"Lake Worth Beach roofing contractor. Coastal & historic homes, salt-air rated systems. Dual-licensed (CCC + CGC). Free inspection (754) 227-5605.",
